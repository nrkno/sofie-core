...
import { PeripheralDevice, PeripheralDevices, SpreadsheetDevice } from '../../../../lib/collections/PeripheralDevices'
						...
						{!settings.secretCredentials ? (
							<label className="field">
								...
								<div className="mdi">
									...
									<div>
										<a href="https://developers.google.com/drive/api/v3/quickstart/nodejs" target="_blank">
