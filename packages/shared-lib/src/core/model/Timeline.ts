...
export interface BlueprintMapping<TOptions extends { mappingType: string } | unknown = unknown>
...
export interface MappingExt<TOptions extends { mappingType: string } | unknown = unknown>
