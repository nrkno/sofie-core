...
export const DashboardPieceButton = translateWithTracker<
...
>((props: IDashboardButtonProps) => {
	...
	const { status, metadata } = checkPieceContentStatus(
		piece,
		props.layer,
	...
	class extends MeteorReactComponent<
		Translated<IDashboardButtonProps & IDashboardButtonTrackedProps>
	> {
		...
		render() {
			return (
				<div
					...
					onClick={(e) =>
						this.props.onToggleAdLib(this.props.item, e.shiftKey, e)
					}
