...
export type WithTimelineObjects<T extends IBlueprintPieceGeneric<unknown>> = T & {
	timelineObjects: TimelineObjectCoreExt[]
}
export type WithPieceTimelineObjects<T extends IBlueprintPieceInstance<unknown>> = T & {
	piece: WithTimelineObjects<T['piece']>
}
