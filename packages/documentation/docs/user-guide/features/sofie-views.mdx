...
This provides an overview of the status of the various Media assets required by this Rundown for playback. You can sort these assets according to their playout order, status, Source Layer Name and Piece Name.
