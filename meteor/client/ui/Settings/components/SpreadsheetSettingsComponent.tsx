...
export const SpreadsheetSettingsComponent = translate()(
	...
	> {
					...
					.catch((err) => {
						NotificationCenter.push(
							new Notification(
								...
								NoticeLevel.WARNING,
								t(
									'Failed to upload spreadsheet credentials: {{errorMessage}}',
									{ errorMessage: err + '' }
								),
								'SpreadsheetSettingsComponent'
							)
		...
		render() {
			const { t } = this.props;
			let settings = (this.props.device.settings ||
				{}) as SpreadsheetDeviceSettings;
					...
					<div className="mod mvs mhn">
						...
						<label className="field">
							...
							<div className="mdi">
								<Tooltip
									overlay={t(
										'Provide the name of the folder to download rundowns from'
									)}
									visible={
										getHelpMode() &&
