...
export const HttpSendDeviceSettingsComponent = translate()(
	...
	> {
		...
		addNewHttpSendCommand() {
			...
			let setObject = {};
			setObject[
				'settings.devices.' + deviceId + '.options.makeReadyCommands'
			] = {
				id: Random.id(),
						...
						<tr
							...
							<td className="settings-studio-device-httpsend__actions table-item-actions c3">
								<button
									...
									onClick={(e) => this.editItem(cmd.id)}>
									<FontAwesomeIcon icon={faPencilAlt} />
								</button>
								<button
									className="action-btn"
									onClick={(e) => this.confirmRemove(cmd.id)}>
				...
				<React.Fragment>
					...
					<div className="mod mhs">
						<button
							...
							onClick={(e) => this.addNewHttpSendCommand()}>
