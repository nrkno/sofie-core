...
* chore: Add default values for new kam and rm input maps ([9ebafe1](https://github.com/nrkno/tv-automation-server-core/commit/9ebafe1))
* chore: added release script ([ef41771](https://github.com/nrkno/tv-automation-server-core/commit/ef41771))
* chore: better logging of mos actions ([38341cc](https://github.com/nrkno/tv-automation-server-core/commit/38341cc))
* chore: clean up SVG markup ([25f6342](https://github.com/nrkno/tv-automation-server-core/commit/25f6342))
* chore: convenience functions for rateLimiting ([0471c87](https://github.com/nrkno/tv-automation-server-core/commit/0471c87))
* chore: Merge develop ([aa4f1a2](https://github.com/nrkno/tv-automation-server-core/commit/aa4f1a2))
* chore: merge from release2 ([5ab9852](https://github.com/nrkno/tv-automation-server-core/commit/5ab9852))
* chore: merge latest release2 ([57cc723](https://github.com/nrkno/tv-automation-server-core/commit/57cc723))
* chore: modalDialog example doc ([99ffaaf](https://github.com/nrkno/tv-automation-server-core/commit/99ffaaf))
* chore: moved cache prefixes into enum ([24dead4](https://github.com/nrkno/tv-automation-server-core/commit/24dead4))
* chore: Remove unused nora_init layer from initDB ([9ef8426](https://github.com/nrkno/tv-automation-server-core/commit/9ef8426))
* chore: Update grafikk lookahead mode ([844decd](https://github.com/nrkno/tv-automation-server-core/commit/844decd))
* chore: Update mock3 to have a valid super in apning kam ([a52863d](https://github.com/nrkno/tv-automation-server-core/commit/a52863d))
* chore:reorganize modifiers in keyboardEventToShortcut ([ac939ce](https://github.com/nrkno/tv-automation-server-core/commit/ac939ce))
* feat:mediaObjects.checkSLIContentStatus ([66d4427](https://github.com/nrkno/tv-automation-server-core/commit/66d4427))
* feat:Peripheral Device user action logging ([2250798](https://github.com/nrkno/tv-automation-server-core/commit/2250798))
* feat:show next take style icon next to timecode ([8d090e8](https://github.com/nrkno/tv-automation-server-core/commit/8d090e8))
* feat(Timeline):Add next segment return arrow at end of segment ([54900a8](https://github.com/nrkno/tv-automation-server-core/commit/54900a8))
* feat(Timeline):end of segment overlay ([41e78ec](https://github.com/nrkno/tv-automation-server-core/commit/41e78ec))
* feat(user log):add action context (trigger event summary) ([ad176f2](https://github.com/nrkno/tv-automation-server-core/commit/ad176f2))
* fix:don't throw in SettingsMenu if sourceLayers are undefined ([3afd7f6](https://github.com/nrkno/tv-automation-server-core/commit/3afd7f6))
* fix:imports in various places ([7d352a8](https://github.com/nrkno/tv-automation-server-core/commit/7d352a8))
* fix:origo-ize datePicker ([db0f4ff](https://github.com/nrkno/tv-automation-server-core/commit/db0f4ff))
* fix:prompter background to black, update documentation ([387ad28](https://github.com/nrkno/tv-automation-server-core/commit/387ad28))
* fix:Settings translation strings were broken in many dialog boxes ([b6ac1fc](https://github.com/nrkno/tv-automation-server-core/commit/b6ac1fc))
* fix:Settings translation strings were broken in many dialog boxesSettings are not translated yet, so ([7053f2c](https://github.com/nrkno/tv-automation-server-core/commit/7053f2c))
* fix:show end marker ([2bd874a](https://github.com/nrkno/tv-automation-server-core/commit/2bd874a))
* fix:Status page styling ([69c4697](https://github.com/nrkno/tv-automation-server-core/commit/69c4697))
* fix:translate datePicker ([ca00c04](https://github.com/nrkno/tv-automation-server-core/commit/ca00c04))
* Fix(RO overview):fix label lengths ([41dea0b](https://github.com/nrkno/tv-automation-server-core/commit/41dea0b))
* Merge branch 'develop' into feature/queueability ([18d45bf](https://github.com/nrkno/tv-automation-server-core/commit/18d45bf))
* Merge branch 'develop' into feature/refactorreset ([8c8dd41](https://github.com/nrkno/tv-automation-server-core/commit/8c8dd41))
* Merge branch 'develop' into release2 ([9b3adc5](https://github.com/nrkno/tv-automation-server-core/commit/9b3adc5))
* Merge branch 'develop' into release2 ([14b8433](https://github.com/nrkno/tv-automation-server-core/commit/14b8433))
* Merge branch 'develop' into release2 ([5807347](https://github.com/nrkno/tv-automation-server-core/commit/5807347))
* Merge branch 'develop' of github.com:nrkno/tv-automation-server-core into develop ([e6f20df](https://github.com/nrkno/tv-automation-server-core/commit/e6f20df))
* Merge branch 'feature/queueability-release2' into release2 ([d96230f](https://github.com/nrkno/tv-automation-server-core/commit/d96230f))
* Merge branch 'feature/queueability' into release2 ([cf95d29](https://github.com/nrkno/tv-automation-server-core/commit/cf95d29))
* Merge branch 'feature/refactorreset' into develop ([5551438](https://github.com/nrkno/tv-automation-server-core/commit/5551438))
* Merge branch 'master' into release2 ([a2b7f86](https://github.com/nrkno/tv-automation-server-core/commit/a2b7f86))
* Merge branch 'release2' into develop ([be8acf8](https://github.com/nrkno/tv-automation-server-core/commit/be8acf8))
* Merge branch 'release2' into develop ([e07e747](https://github.com/nrkno/tv-automation-server-core/commit/e07e747))
* Merge branch 'release2' of github.com:nrkno/tv-automation-server-core into release2 ([f6b729a](https://github.com/nrkno/tv-automation-server-core/commit/f6b729a))
...
* fix: Add missing _rank field to SegmentLineAdLibItem ([9cd15fa](https://github.com/nrkno/tv-automation-server-core/commit/9cd15fa))
* fix: added missing getRank import ([9d37eb8](https://github.com/nrkno/tv-automation-server-core/commit/9d37eb8))
* fix: lock down package.json & update package-lock, to get release2 to build ([472f8ab](https://github.com/nrkno/tv-automation-server-core/commit/472f8ab))
* fix: proper dispose of executeFunction checkReply after execution is done ([523ec99](https://github.com/nrkno/tv-automation-server-core/commit/523ec99))
* fix: refactored reset-segmentLine further ([0523eb6](https://github.com/nrkno/tv-automation-server-core/commit/0523eb6))
* fix: Remove timestamps from blueprint backups ([74fa1b3](https://github.com/nrkno/tv-automation-server-core/commit/74fa1b3))
* fix: resetRunningOrder functionality in GUI ([4eb096a](https://github.com/nrkno/tv-automation-server-core/commit/4eb096a))
* fix: resolve merge issue ([0cbc75a](https://github.com/nrkno/tv-automation-server-core/commit/0cbc75a))
* fix: roReset should reset holdItems and infinites ([bdf8385](https://github.com/nrkno/tv-automation-server-core/commit/bdf8385))
* fix: Tweaked styling of evaluation form, warning messages, color of the next lines, translations, ca ([50d2753](https://github.com/nrkno/tv-automation-server-core/commit/50d2753))
* fix: updated nightly cronjob: restart casparcg devices, to work with new restartCasparCG function im ([edbc186](https://github.com/nrkno/tv-automation-server-core/commit/edbc186))
* fix: when activating, set Next if not set ([c9f71a1](https://github.com/nrkno/tv-automation-server-core/commit/c9f71a1))
* fix(timeline): don't round items in relative mode ([2938819](https://github.com/nrkno/tv-automation-server-core/commit/2938819))
* fix(timeline): Infinite sli do not update properly on new mos data. Fix detection of the end of the  ([16d9715](https://github.com/nrkno/tv-automation-server-core/commit/16d9715))
* fix(transition): Delay sli not contents, to ensure relative triggers against the sli are correct (fi ([856da4b](https://github.com/nrkno/tv-automation-server-core/commit/856da4b))
* feat: Add typeSubVariant field to SegmentLine. (#46) ([4af88d3](https://github.com/nrkno/tv-automation-server-core/commit/4af88d3)), closes [#46](https://github.com/nrkno/tv-automation-server-core/issues/46)
* feat: Add typeSubVariant field to SegmentLine. (#46) ([82bd4bd](https://github.com/nrkno/tv-automation-server-core/commit/82bd4bd)), closes [#46](https://github.com/nrkno/tv-automation-server-core/issues/46)
* feat: changed restart CasparCG functionality ([dd567c2](https://github.com/nrkno/tv-automation-server-core/commit/dd567c2))
* feat: Grafikk lookahead/preload ([30a6b03](https://github.com/nrkno/tv-automation-server-core/commit/30a6b03))
* feat: handle mos updates with dynamicallyInserted segmentLines ([1d292c0](https://github.com/nrkno/tv-automation-server-core/commit/1d292c0))
* feat: Move SegmentLine duration calculation into templates ([315eb42](https://github.com/nrkno/tv-automation-server-core/commit/315eb42))
* feat: prompter-view ([f45a923](https://github.com/nrkno/tv-automation-server-core/commit/f45a923))
* feat: reworked the whole activate/deacticate/reset/reload logic ([1fea56e](https://github.com/nrkno/tv-automation-server-core/commit/1fea56e))
* feat: server side implementation of queueabilified adlibs ([0527b3b](https://github.com/nrkno/tv-automation-server-core/commit/0527b3b))
* feat(device): Custom make-ready commands for httpsend device ([410a2ef](https://github.com/nrkno/tv-automation-server-core/commit/410a2ef))
* feat(Prompter): implement a simple mirror mode ([8d0be4e](https://github.com/nrkno/tv-automation-server-core/commit/8d0be4e))
* feat(shortcuts): standarize shortcut label display, support numpad ([4c5ba74](https://github.com/nrkno/tv-automation-server-core/commit/4c5ba74))
* feat(Timeline): more work on new marker style ([570e408](https://github.com/nrkno/tv-automation-server-core/commit/570e408))
* Chore: fix tslint warnings in mockData/mosData, since that's just mock ([ac054a7](https://github.com/nrkno/tv-automation-server-core/commit/ac054a7))
* Chore: merge from develop ([10e6358](https://github.com/nrkno/tv-automation-server-core/commit/10e6358))
* Chore: Merge release2 ([b2ea1b2](https://github.com/nrkno/tv-automation-server-core/commit/b2ea1b2))
* Chore: update meteor to 1.6.1.4 ([49a4ae6](https://github.com/nrkno/tv-automation-server-core/commit/49a4ae6))
* Feat: a better implementation of SourceLayerItemContainer ([38380e1](https://github.com/nrkno/tv-automation-server-core/commit/38380e1))
* Feat: add fast reset action ([129e300](https://github.com/nrkno/tv-automation-server-core/commit/129e300))
* Feat: add support for two-tone splits with the same source type ([ba70dfa](https://github.com/nrkno/tv-automation-server-core/commit/ba70dfa))
* Feat: new style of segmentLine markers (WIP) ([a3569ce](https://github.com/nrkno/tv-automation-server-core/commit/a3569ce))
* Feat: queueability feature - GUI ([dcfa4a0](https://github.com/nrkno/tv-automation-server-core/commit/dcfa4a0))
* Feat: source layer exclusivity groups (wip) ([7dedc85](https://github.com/nrkno/tv-automation-server-core/commit/7dedc85))
* Feat: sourceLayer exclusivity groups ([c32f0e1](https://github.com/nrkno/tv-automation-server-core/commit/c32f0e1))
* Feat: two-tone Split layers with more than one input of the same type ([60c238c](https://github.com/nrkno/tv-automation-server-core/commit/60c238c))
* Feat(RO view): Retain the special segment color even when On Air/Next ([2596a8e](https://github.com/nrkno/tv-automation-server-core/commit/2596a8e))
* Feat(Timeline): End of Show marker ([01aefb5](https://github.com/nrkno/tv-automation-server-core/commit/01aefb5))
* Fix: a workaround for Monaco Ctrl+V shortcut issue. ([aead169](https://github.com/nrkno/tv-automation-server-core/commit/aead169))
* Fix: a workaround for Monaco Ctrl+V shortcut issue. ([41389ee](https://github.com/nrkno/tv-automation-server-core/commit/41389ee))
* Fix: Display OK status in RO View with nowrap ([0763c3a](https://github.com/nrkno/tv-automation-server-core/commit/0763c3a))
* Fix: fix merge with relese2 ([e39893b](https://github.com/nrkno/tv-automation-server-core/commit/e39893b))
* Fix: rewindsegments on resetRunningOrder ([57c1c53](https://github.com/nrkno/tv-automation-server-core/commit/57c1c53))
* Fix: smarter reloadRunningOrder ([33c11ba](https://github.com/nrkno/tv-automation-server-core/commit/33c11ba))
* Fix: styling fix in ShowStyleSettings ([681163a](https://github.com/nrkno/tv-automation-server-core/commit/681163a))
* Fix(ModalDialog): Don't wrap p elements in a p element ([fa4dcf9](https://github.com/nrkno/tv-automation-server-core/commit/fa4dcf9))
