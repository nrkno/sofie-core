...
const TimelineView = translateWithTracker<
	ITimelineViewProps,
	ITimelineViewState,
	{}
>((props: ITimelineViewProps) => {
	return {};
})(
	class TimelineView extends MeteorReactComponent<
		Translated<ITimelineViewProps>,
		ITimelineViewState
	> {
	...
	> {
		...
		componentDidUpdate() {
			if (this.startVisualizer) {
				...
				if (!this.visualizer) {
					// initialize
					this.visualizer = new TimelineVisualizer.TimelineVisualizer(
						'timeline-visualizer',
						{
							drawPlayhead: true
						}
...
>((props: ITimelineSimulateProps) => {
	...
	class extends MeteorReactComponent<
		ITimelineSimulateProps & ITimelineSimulateState
	> {
