/* eslint-disable */
// Copied from: https://github.com/meteor/meteor/blob/7a168776b444a48f18c9ba5ce72363360e59e678/npm-packages/meteor-babel/plugins/async-await.js
			...
			Function: {
				exit: function (path) {
					...
					const promiseResultExpression = t.callExpression(
						t.memberExpression(t.identifier('Promise'), t.identifier('asyncApply'), false),
						[innerFn]
					)
					...
					if (node.type === 'ArrowFunctionExpression') {
						...
						node.body = t.blockStatement([t.returnStatement(promiseResultExpression)])
					}
				},
			},
