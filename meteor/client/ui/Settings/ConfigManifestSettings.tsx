...
import { faDownload, faTrash, faPencilAlt, faCheck, faPlus, faUpload, faSortUp, faSortDown, faSort } from '@fortawesome/free-solid-svg-icons'
	...
	renderEditableArea (item: ConfigManifestEntry, valIndex: number) {
		...
		switch (item.type) {
			case ConfigManifestEntryType.TABLE:
				...
				return <ConfigManifestTable t={t} i18n={i18n} tReady={tReady} collection={collection} object={object} baseAttribute={baseAttribute} item={item2} layerMappings={this.props.layerMappings} sourceLayers={this.props.sourceLayers} />
			case ConfigManifestEntryType.SELECT:
			case ConfigManifestEntryType.LAYER_MAPPINGS:
			case ConfigManifestEntryType.SOURCE_LAYERS:
				return (
