		...
		return (
			<tr className={ClassNames('adlib-panel__list-view__list__segment__item', {
				...
				<td className={ClassNames(
					...
					{
						'source-missing': this.props.item.status === RundownAPI.PieceStatusCode.SOURCE_MISSING,
						'source-broken': this.props.item.status === RundownAPI.PieceStatusCode.SOURCE_BROKEN,
						'unknown-state': this.props.item.status === RundownAPI.PieceStatusCode.UNKNOWN
					}
				)}>
