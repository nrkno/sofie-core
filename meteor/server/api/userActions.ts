...
export function userStoreRundownSnapshot (rundownPlaylistId: string, reason: string) {
	return ClientAPI.responseSuccess(
		storeRundownSnapshot(rundownPlaylistId, reason)
	)
}
...
methods[UserActionAPI.methods.sourceLayerOnPartStop] = function (rundownPlaylistId: string, partInstanceId: string, sourceLayerIds: string[] | string) {
	return sourceLayerOnPartStop.call(this, rundownPlaylistId, partInstanceId, sourceLayerIds)
}
...
methods[UserActionAPI.methods.storeRundownSnapshot] = function (rundownPlaylistId: string, reason: string) {
	return userStoreRundownSnapshot.call(this, rundownPlaylistId, reason)
}
