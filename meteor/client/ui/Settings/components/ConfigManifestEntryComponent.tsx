...
export const ConfigManifestEntryComponent = translate()(
	class ConfigManifestEntryComponent extends React.Component<
		Translated<IConfigManifestEntryComponentProps>,
		{}
	> {
		renderEditAttribute(configField: ConfigManifestEntry, obj?: any, prefix?: string) {
			...
			if (
				configField.type === ConfigManifestEntryType.FLOAT ||
				configField.type === ConfigManifestEntryType.INT
			) {
				return (
					<EditAttribute
						modifiedClassName="bghl"
						attribute={attribute}
						obj={obj || this.props.device}
