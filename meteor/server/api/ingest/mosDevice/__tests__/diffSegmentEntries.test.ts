	...
	describe('diffSegmentEntries', () => {
		const ingestSegments: LocalIngestSegment[] = [
			{
				...
				name: 'Overblik',
				parts: [
					{ name: 'AA3D07094F51297F', rank: 0, externalId: '2012R2ENPS8VM;P_ENPSMOS\\W\\F_HOLD ROs\\R_B10067B2-434B-4CF3-AFB1A02EEF8760CB;C355011E-B1E2-425E-AA3D07094F51297F', modified: Date.now() },
					{ name: 'AC9369C6A140CEBB', rank: 1, externalId: '2012R2ENPS8VM;P_ENPSMOS\\W\\F_HOLD ROs\\R_B10067B2-434B-4CF3-AFB1A02EEF8760CB;484B952B-DE0F-40A0-AC9369C6A140CEBB', modified: Date.now() },
					{ name: '8DAE5BF534A0EAD8', rank: 2, externalId: '2012R2ENPS8VM;P_ENPSMOS\\W\\F_HOLD ROs\\R_B10067B2-434B-4CF3-AFB1A02EEF8760CB;F285B8FA-BD5F-492B-8DAE5BF534A0EAD8', modified: Date.now() },
					{ name: 'B7D35BBDBFD9A4D2', rank: 3, externalId: '2012R2ENPS8VM;P_ENPSMOS\\W\\F_HOLD ROs\\R_B10067B2-434B-4CF3-AFB1A02EEF8760CB;AE66B8D8-4595-4CA5-B7D35BBDBFD9A4D2', modified: Date.now() },
					{ name: '8A872A00510269E', rank: 4, externalId: '2012R2ENPS8VM;P_ENPSMOS\\W\\F_HOLD ROs\\R_B10067B2-434B-4CF3-AFB1A02EEF8760CB;5C4EE8B8-5459-4A94-8A872A00510269E8', modified: Date.now() },
				],
				modified: Date.now()
			},
			{
				...
				name: 'Møller og DBU',
				parts: [
					{ name: 'BB605A012DFAF93E', rank: 0, externalId: '2012R2ENPS8VM;P_ENPSMOS\\W\\F_HOLD ROs\\R_B10067B2-434B-4CF3-AFB1A02EEF8760CB;0D1D077D-9720-4560-BB605A012DFAF93E', modified: Date.now() },
					{ name: 'B21E0F016576BC73', rank: 1, externalId: '2012R2ENPS8VM;P_ENPSMOS\\W\\F_HOLD ROs\\R_B10067B2-434B-4CF3-AFB1A02EEF8760CB;D7CCC920-28E9-41AC-B21E0F016576BC73', modified: Date.now() },
					{ name: '8E100AB374A15DEA', rank: 2, externalId: '2012R2ENPS8VM;P_ENPSMOS\\W\\F_HOLD ROs\\R_B10067B2-434B-4CF3-AFB1A02EEF8760CB;D87D86D3-FD0A-42AC-8E100AB374A15DEA', modified: Date.now() },
					{ name: '86360F634827C56A', rank: 3, externalId: '2012R2ENPS8VM;P_ENPSMOS\\W\\F_HOLD ROs\\R_B10067B2-434B-4CF3-AFB1A02EEF8760CB;950A200E-31CA-4DEA-86360F634827C56A', modified: Date.now() },
				],
				modified: Date.now()
			},
			{
				...
				parts: [
					{ name: 'A0C24CCA21FE9969', rank: 0, externalId: '2012R2ENPS8VM;P_ENPSMOS\\W\\F_HOLD ROs\\R_B10067B2-434B-4CF3-AFB1A02EEF8760CB;56CB0445-5782-4F92-A0C24CCA21FE9969', modified: Date.now() },
				],
				modified: Date.now()
			},
			{
				...
				name: 'Møller og DBU',
				parts: [
					{ name: 'B41C095014F35C2E', rank: 0, externalId: '2012R2ENPS8VM;P_ENPSMOS\\W\\F_HOLD ROs\\R_B10067B2-434B-4CF3-AFB1A02EEF8760CB;3487F683-5939-4A37-B41C095014F35C2E', modified: Date.now() },
					{ name: 'B9D0B70BA3F30F69', rank: 1, externalId: '2012R2ENPS8VM;P_ENPSMOS\\W\\F_HOLD ROs\\R_B10067B2-434B-4CF3-AFB1A02EEF8760CB;A0BF2B88-EE9E-40B7-B9D0B70BA3F30F69', modified: Date.now() },
					{ name: '87B4F8206386BBDD', rank: 2, externalId: '2012R2ENPS8VM;P_ENPSMOS\\W\\F_HOLD ROs\\R_B10067B2-434B-4CF3-AFB1A02EEF8760CB;D05B62C7-19F8-4CD7-87B4F8206386BBDD', modified: Date.now() },
				],
				modified: Date.now()
			}
		]
		...
		test('Insert new segment', async () => {
			...
			ingestSegments2.splice(0, 0, {
				...
				name: 'New Name',
				parts: [
					{ name: 'abc', rank: 0, externalId: 'abc', modified: Date.now() },
				],
				modified: Date.now()
			})
			recalculateRank(ingestSegments2)
		...
		test('Insert new segment, split existing', async () => {
			...
			ingestSegments2.splice(1, 0, {
				...
				name: 'New Name2',
				parts: [
					{ name: 'abc2', rank: 0, externalId: 'abc2', modified: Date.now() },
				],
				modified: Date.now()
			})
			recalculateRank(ingestSegments2)
