...
describe('Ingest: MOS', () => {
	describe('diffSegmentEntries', () => {
		...
		test('Remove to combine segments', async () => {
			...
			let ingestSegments2 = clone(ingestSegments);
			ingestSegments2[1].parts = ingestSegments2[1].parts.concat(
				ingestSegments2[3].parts
			);
		...
		test('Insert into segment', async () => {
			...
			// First segment
			const ingestSegments2 = clone(ingestSegments);
			ingestSegments2[0].parts.splice(2, 0, {
				name: 'abc',
				rank: 2.5,
				externalId: 'abc'
			});
			...
			// Middle segment
			const ingestSegments3 = clone(ingestSegments);
			ingestSegments3[1].parts.splice(2, 0, {
				name: 'abc',
				rank: 2.5,
				externalId: 'abc'
			});
			...
			// Last segment
			const ingestSegments4 = clone(ingestSegments);
			ingestSegments4[3].parts.splice(2, 0, {
				name: 'abc',
				rank: 2.5,
				externalId: 'abc'
			});
