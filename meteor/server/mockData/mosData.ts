...
setMeteorMethods({
	...
	'debug_roDelete' () {
		let pd = getPD()
		Meteor.call(PeripheralDeviceAPI.methods.mosRoDelete, pd._id, pd.token, new MOS.MosString128('' + xmlApiData.roDelete))
	},
	'debug_roMock0_remove' () {
		let pd = getPD()
		Meteor.call(PeripheralDeviceAPI.methods.mosRoDelete, pd._id, pd.token,
			new MOS.MosString128('MAENPSTEST14;P_SERVER14\\W;07C8C71B-1835-493D-94E1678FD1425B71'))
	},
	'debug_fakeMosDevice' () {
		...
		Meteor.call(PeripheralDeviceAPI.methods.mosRoFullStory, id, token,
			{
				...
				"MosExternalMetaData": [{
					...
					"MosPayload": {
						...
						"MOS.MOSTimes": "20180502T165008720Z",
						"Owner": "LINUXENPS",
						"SourceMediaTime": 0,
						"SourceTextTime": 0,
				...
				"MosExternalMetaData":[
				   {
					  ...
					  "MosPayload":{
						 ...
						 "MOS.MOSTimes":"20180502T165013906Z",
						 "Owner":"LINUXENPS",
				...
				"MosExternalMetaData":[
				   {
					  ...
					  "MosPayload":{
						 ...
						 "MOS.MOSTimes":"20180502T165021004Z",
						 "Owner":"LINUXENPS",
						 "Printed":"20180502T164204Z",
						 "SourceMediaTime":0,
						 "SourceTextTime":0,
				...
				"MosExternalMetaData":[
				   {
					  ...
					  "MosPayload":{
						 ...
						 "MOS.MOSTimes":"20180502T165026622Z",
						 "Owner":"LINUXENPS",
						 "SourceMediaTime":0,
						 "SourceTextTime":0,
	...
	'debug_roMock1_remove' () {
		let pd = getPD()
		Meteor.call(PeripheralDeviceAPI.methods.mosRoDelete, pd._id, pd.token,
			new MOS.MosString128('MAENPSTEST14;P_SERVER14\\W;B39BEF9C-78A3-4A4E-A33BFDB09371EDF5'))
	},
	'debug_roMock1' () {
		let pd = getPD()
		if (!pd) {
	...
	'debug_roMock2' () {
		...
		Meteor.call(PeripheralDeviceAPI.methods.mosRoDelete, id, token,
			new MOS.MosString128('MAENPSTEST14;P_SERVER14\\W;35F60587-876E-4CF1-AE0946FA90C55446'))
		//
		Meteor.call(PeripheralDeviceAPI.methods.mosRoCreate, id, token,
			{
				...
				"MosExternalMetaData" : [
					{
						...
						"MosPayload" : {
							...
							"MOS.MOSTimes" : 20171213175731804.0,
							"Owner" : "N12050",
							"SourceMediaTime" : 0,
							"SourceTextTime" : 0,
