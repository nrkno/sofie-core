	...
	class extends React.Component<Translated<IListViewPropsHeader>, IListViewStateHeader> {
						...
						this.props.rundownAdLibs
							...
							.map((item: AdLibPieceUi) => (
								<AdLibListItem
									...
									item={item}
									selected={
										(this.props.selectedPart && this.props.selectedPart._id === item._id) || false
									}
		...
		renderSegments() {
			return this.props.uiSegments
				.filter((a) =>
					this.props.filter ? (this.props.filter.currentSegment ? a.isLive : true) : true
				)
				.map((seg) => {
					return (
						<tbody
								...
								seg.pieces
									...
									.map((item: AdLibPieceUi) => (
										<AdLibListItem
											...
											item={item}
											selected={
												(this.props.selectedPart && this.props.selectedPart._id === item._id) ||
												false
											}
											layer={this.state.sourceLayers[item.sourceLayerId]}
											outputLayer={this.state.outputLayers[item.outputLayerId]}
