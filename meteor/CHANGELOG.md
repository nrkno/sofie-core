...
* chore: add missing packages to version ignore list ([667c6a4](https://github.com/nrkno/tv-automation-server-core/commit/667c6a4))
* chore: add missing userAction names ([915a36e](https://github.com/nrkno/tv-automation-server-core/commit/915a36e))
...
* chore: Add tests for playout infinite generation logic ([a6a8fcd](https://github.com/nrkno/tv-automation-server-core/commit/a6a8fcd))
* chore: adds react-circular-progressbar dependency ([8409bc8](https://github.com/nrkno/tv-automation-server-core/commit/8409bc8))
...
* chore: document migration ([42649e4](https://github.com/nrkno/tv-automation-server-core/commit/42649e4))
...
* chore: increased granularity of translation fallbacks ([013f45f](https://github.com/nrkno/tv-automation-server-core/commit/013f45f))
* chore: linting ([4f612fa](https://github.com/nrkno/tv-automation-server-core/commit/4f612fa))
* chore: linting & housekeeping ([2bed3ff](https://github.com/nrkno/tv-automation-server-core/commit/2bed3ff))
* chore: making changelog a bit more human-readable ([a27289c](https://github.com/nrkno/tv-automation-server-core/commit/a27289c))
* chore: merge develop changes ([5d981e3](https://github.com/nrkno/tv-automation-server-core/commit/5d981e3))
...
* chore: move saveEvaluations out of userActions (no real actions should be performed there) ([9d26277](https://github.com/nrkno/tv-automation-server-core/commit/9d26277))
* chore: omit some more libraries on startup ([96b96e3](https://github.com/nrkno/tv-automation-server-core/commit/96b96e3))
* chore: prepare databaseMigrations ([5db28e6](https://github.com/nrkno/tv-automation-server-core/commit/5db28e6))
...
* chore: update nn translation support ([dc9d611](https://github.com/nrkno/tv-automation-server-core/commit/dc9d611))
...
* chore: Updated case on a headline. ([eca2bdf](https://github.com/nrkno/tv-automation-server-core/commit/eca2bdf))
* chore: Updated NB and NN translations. ([4d09503](https://github.com/nrkno/tv-automation-server-core/commit/4d09503))
...
* chore(media manager UI): drop unnecessary checks after getPeripheralDevice ([33fde80](https://github.com/nrkno/tv-automation-server-core/commit/33fde80))
* chore(release): 0.21.0-0 ([3fd5334](https://github.com/nrkno/tv-automation-server-core/commit/3fd5334))
* chore(release): cherry-pick package version from release 6 ([c1b0961](https://github.com/nrkno/tv-automation-server-core/commit/c1b0961))
* chore(release): copy version from master ([a6884d9](https://github.com/nrkno/tv-automation-server-core/commit/a6884d9))
*  fix: add nn translation to whitelist ([c4d859a](https://github.com/nrkno/tv-automation-server-core/commit/c4d859a))
* chore: ([52f983c](https://github.com/nrkno/tv-automation-server-core/commit/52f983c))
* chore:Updated NB translations and fixed a few case-errors in headlines. ([a7c6365](https://github.com/nrkno/tv-automation-server-core/commit/a7c6365))
...
* fix: add missing  translation json-file ([6059965](https://github.com/nrkno/tv-automation-server-core/commit/6059965))
* fix: add missing _id ([970fbf8](https://github.com/nrkno/tv-automation-server-core/commit/970fbf8))
* fix: add missing _id ([c948d09](https://github.com/nrkno/tv-automation-server-core/commit/c948d09))
* fix: add missing core version ([8ad3a9e](https://github.com/nrkno/tv-automation-server-core/commit/8ad3a9e))
* fix: add nn translation to whitelist ([4663e3b](https://github.com/nrkno/tv-automation-server-core/commit/4663e3b))
* fix: added a place to run updateExpectedMediaItems ([c70704d](https://github.com/nrkno/tv-automation-server-core/commit/c70704d))
* fix: allow esc & enter in modalDialog ([cd511b6](https://github.com/nrkno/tv-automation-server-core/commit/cd511b6))
* fix: allow re-sync of unsynced RO while it is active ([b824d72](https://github.com/nrkno/tv-automation-server-core/commit/b824d72))
* fix: allow removing peripheralDevices from Settings page ([b14e56a](https://github.com/nrkno/tv-automation-server-core/commit/b14e56a))
* fix: anomaly timings as numbers ([d0c0d36](https://github.com/nrkno/tv-automation-server-core/commit/d0c0d36))
* fix: another bugfix ([c7ed208](https://github.com/nrkno/tv-automation-server-core/commit/c7ed208))
* fix: asRunLog: defer handleEvent, to make sure all events have been reported before running. ([6c56ec7](https://github.com/nrkno/tv-automation-server-core/commit/6c56ec7))
* fix: break long script better in hoverscrub ([2d2f26d](https://github.com/nrkno/tv-automation-server-core/commit/2d2f26d))
* fix: break long script better in hoverscrub ([5697493](https://github.com/nrkno/tv-automation-server-core/commit/5697493))
* fix: bugfix ([943ff72](https://github.com/nrkno/tv-automation-server-core/commit/943ff72))
* fix: bugfix, some keys didn't work in text inputs ([36e99cb](https://github.com/nrkno/tv-automation-server-core/commit/36e99cb))
* fix: bugfix: updateExpectedMediaItems used all segmentLineItems in RO, not just in segmmentLine ([406829b](https://github.com/nrkno/tv-automation-server-core/commit/406829b))
* fix: bumps expected version ([bd06edc](https://github.com/nrkno/tv-automation-server-core/commit/bd06edc))
* fix: changed how i18n is initialized & exported ([cc674aa](https://github.com/nrkno/tv-automation-server-core/commit/cc674aa))
* fix: check content.path before creating an ExpectedMediaItem ([0914e98](https://github.com/nrkno/tv-automation-server-core/commit/0914e98))
* fix: ConfigRef fix ([f557052](https://github.com/nrkno/tv-automation-server-core/commit/f557052))
* fix: enforce workflow data structure ([d01245f](https://github.com/nrkno/tv-automation-server-core/commit/d01245f))
* fix: ensure that the connection notification is always on top ([662cd7a](https://github.com/nrkno/tv-automation-server-core/commit/662cd7a))
* fix: Ensure typeVariant on SegmentLine is preserved when a roList is received ([98b224c](https://github.com/nrkno/tv-automation-server-core/commit/98b224c))
* fix: expectedMediaItems: make ids uniquer ([e16594a](https://github.com/nrkno/tv-automation-server-core/commit/e16594a))
* fix: fix notifications toggle button cursor ([b0d8dcb](https://github.com/nrkno/tv-automation-server-core/commit/b0d8dcb))
* fix: freeze/black in begin/end of mediafile gets special warning ([ea950e2](https://github.com/nrkno/tv-automation-server-core/commit/ea950e2))
* fix: GUI externalMessages json formatting ([0b7cd2c](https://github.com/nrkno/tv-automation-server-core/commit/0b7cd2c))
* fix: handle promises correctly.. ([b952e1d](https://github.com/nrkno/tv-automation-server-core/commit/b952e1d))
* fix: handle promises correctly.. ([2e57296](https://github.com/nrkno/tv-automation-server-core/commit/2e57296))
* fix: improve notifications highlighting animation ([abda2c3](https://github.com/nrkno/tv-automation-server-core/commit/abda2c3))
* fix: increase upload limit for backup files ([e658f12](https://github.com/nrkno/tv-automation-server-core/commit/e658f12))
* fix: initial optimization of updateSourceLayerInfinitesAfterLine ([871bdd2](https://github.com/nrkno/tv-automation-server-core/commit/871bdd2))
* fix: initial optimization of updateSourceLayerInfinitesAfterLine ([5cd8235](https://github.com/nrkno/tv-automation-server-core/commit/5cd8235))
* fix: issue with source layers marked as used even though they were used in the following segmentLine ([71acfb3](https://github.com/nrkno/tv-automation-server-core/commit/71acfb3))
* fix: logics bugfix after optimization ([fe85cd3](https://github.com/nrkno/tv-automation-server-core/commit/fe85cd3))
* fix: logics bugfix after optimization ([2b8fa3c](https://github.com/nrkno/tv-automation-server-core/commit/2b8fa3c))
* fix: make sure that the ad-lib drawer isn't obstructed by the right-hand bar ([8783819](https://github.com/nrkno/tv-automation-server-core/commit/8783819))
* fix: media-manager: rename keyStep => criticalStep ([77f4d6a](https://github.com/nrkno/tv-automation-server-core/commit/77f4d6a))
* fix: mediainfo typings & timebase ([67f16be](https://github.com/nrkno/tv-automation-server-core/commit/67f16be))
* fix: move all segment notes away from header, show only summary, clickable summary ([aee3d01](https://github.com/nrkno/tv-automation-server-core/commit/aee3d01))
* fix: move notifications pop-ups when NC is open ([6f7759f](https://github.com/nrkno/tv-automation-server-core/commit/6f7759f))
* fix: non-persistent pop-ups should be prioritized over persistent ones ([99f147a](https://github.com/nrkno/tv-automation-server-core/commit/99f147a))
* fix: NotificationCenter visual fix for other pages ([2c5da97](https://github.com/nrkno/tv-automation-server-core/commit/2c5da97))
* fix: optimizations during ad-libs (thanks to @baltedewit) ([f50b60e](https://github.com/nrkno/tv-automation-server-core/commit/f50b60e))
* fix: optimizations during ad-libs (thanks to @baltedewit) ([daa135b](https://github.com/nrkno/tv-automation-server-core/commit/daa135b))
* fix: peripheralDevices subscription for RO data ([90b4e13](https://github.com/nrkno/tv-automation-server-core/commit/90b4e13))
* fix: rabbitMQ sending messages ([df72c4c](https://github.com/nrkno/tv-automation-server-core/commit/df72c4c))
* fix: RecordedFiles index ([f1aae5e](https://github.com/nrkno/tv-automation-server-core/commit/f1aae5e))
* fix: refactor updateExternalMessageQueueStatus to avoid fatal startup bug ([b54b09d](https://github.com/nrkno/tv-automation-server-core/commit/b54b09d))
* fix: remove 'computation stopped' notifications ([bf4d8d8](https://github.com/nrkno/tv-automation-server-core/commit/bf4d8d8))
* fix: Remove empty translations ([d2f1bd0](https://github.com/nrkno/tv-automation-server-core/commit/d2f1bd0))
* fix: remove expectedMediaItems when ro is removed ([5230695](https://github.com/nrkno/tv-automation-server-core/commit/5230695))
* fix: remove leftover debug info ([d475b76](https://github.com/nrkno/tv-automation-server-core/commit/d475b76))
* fix: remove unneccessary margin in some headers ([b47ea11](https://github.com/nrkno/tv-automation-server-core/commit/b47ea11))
* fix: remove unneccessary margin in some headers ([32874a1](https://github.com/nrkno/tv-automation-server-core/commit/32874a1))
* fix: Removed the hard-coded link in the header that set the translation to Norwegian Bokmål. ([4515066](https://github.com/nrkno/tv-automation-server-core/commit/4515066))
* fix: removed wrongful error throw ([b3deed1](https://github.com/nrkno/tv-automation-server-core/commit/b3deed1))
* fix: removed wrongful error throw ([852c495](https://github.com/nrkno/tv-automation-server-core/commit/852c495))
* fix: rename method getShowStyleRef => getShowStyleConfigRef ([c8bbe95](https://github.com/nrkno/tv-automation-server-core/commit/c8bbe95))
* fix: rename version 0.20.0 => 0.21.0 (release 6) ([7b1ee3a](https://github.com/nrkno/tv-automation-server-core/commit/7b1ee3a))
* fix: resolve a typo in rabbitMQ.ts ([3b36ae3](https://github.com/nrkno/tv-automation-server-core/commit/3b36ae3))
* fix: resolve issue with ContextMenus in RO view ([8d9ba96](https://github.com/nrkno/tv-automation-server-core/commit/8d9ba96))
* fix: resolve issue with lowPriority cron jobs ([f7c3c83](https://github.com/nrkno/tv-automation-server-core/commit/f7c3c83))
* fix: RO notification action ([36cf900](https://github.com/nrkno/tv-automation-server-core/commit/36cf900))
* fix: RO Notifications fixes attempt no. 3 ([f0eee1f](https://github.com/nrkno/tv-automation-server-core/commit/f0eee1f))
* fix: Running Order Notifications in activeRo view ([63658b1](https://github.com/nrkno/tv-automation-server-core/commit/63658b1))
* fix: separate warnings for black frames & freeze frames ([e2acad5](https://github.com/nrkno/tv-automation-server-core/commit/e2acad5))
* fix: set tsr multithreading from UI instead of CLI ([c8be25b](https://github.com/nrkno/tv-automation-server-core/commit/c8be25b))
* fix: show connected devices in RO view ([e804d1e](https://github.com/nrkno/tv-automation-server-core/commit/e804d1e))
* fix: some minor react errors in the settings ([d7bb849](https://github.com/nrkno/tv-automation-server-core/commit/d7bb849))
* fix: some more margin touch-ups ([c8b6f1e](https://github.com/nrkno/tv-automation-server-core/commit/c8b6f1e))
* fix: some more margin touch-ups ([71a291a](https://github.com/nrkno/tv-automation-server-core/commit/71a291a))
* fix: temporary fix for the "UnhandledPromiseRejectionWarning" bug, supressing the error when used ([7aa7cf8](https://github.com/nrkno/tv-automation-server-core/commit/7aa7cf8))
* fix: test-tools decklink input format dropdown has no options ([b02f447](https://github.com/nrkno/tv-automation-server-core/commit/b02f447))
* fix: timelineObj _id missing ([1dcedbf](https://github.com/nrkno/tv-automation-server-core/commit/1dcedbf))
* fix: timelineObj _id missing ([0f8e0da](https://github.com/nrkno/tv-automation-server-core/commit/0f8e0da))
* fix: Typographic tweaks for prompter. ([068d535](https://github.com/nrkno/tv-automation-server-core/commit/068d535))
* fix: ui manualPlayback key ([5d4e49f](https://github.com/nrkno/tv-automation-server-core/commit/5d4e49f))
* fix: ui manualPlayback key ([ca1a943](https://github.com/nrkno/tv-automation-server-core/commit/ca1a943))
* fix: update asRunLog typings ([5d18c66](https://github.com/nrkno/tv-automation-server-core/commit/5d18c66))
* fix: Update some playout timelineobj types ([fe883a8](https://github.com/nrkno/tv-automation-server-core/commit/fe883a8))
* fix: updateExpectedMediaItems failing was causing the post-process blueprint to not be run. Errors f ([2fe22bb](https://github.com/nrkno/tv-automation-server-core/commit/2fe22bb))
* fix: use admin as parameter instead of all ([20751b4](https://github.com/nrkno/tv-automation-server-core/commit/20751b4))
* fix: useractions: proper handling of the this keyword ([a2686db](https://github.com/nrkno/tv-automation-server-core/commit/a2686db))
* fix: useractions: proper handling of the this keyword ([49a44a7](https://github.com/nrkno/tv-automation-server-core/commit/49a44a7))
* fix: Wrong icon for split in presenter view ([08c8df8](https://github.com/nrkno/tv-automation-server-core/commit/08c8df8))
* fix: Wrong icon for split in presenter view ([1ec1c56](https://github.com/nrkno/tv-automation-server-core/commit/1ec1c56))
* fix(adlib): Allow for overlap of adlib sli to give preload time ([d2f0dcd](https://github.com/nrkno/tv-automation-server-core/commit/d2f0dcd))
* fix(adlib): An adlib replacing the main sli of a sl would not adjust the length of the original. F5/ ([fca6f05](https://github.com/nrkno/tv-automation-server-core/commit/fca6f05))
* fix(adlib): Set as next on SL after using F5/F6 would not restore correctly ([3829293](https://github.com/nrkno/tv-automation-server-core/commit/3829293))
* fix(clip metadata): timebase info ([5c39ea8](https://github.com/nrkno/tv-automation-server-core/commit/5c39ea8))
* fix(expected media items): use a function instead of fat arrow ([fa23c05](https://github.com/nrkno/tv-automation-server-core/commit/fa23c05))
* fix(L3rd pop-up): filter out properties starting with @ ([19977e7](https://github.com/nrkno/tv-automation-server-core/commit/19977e7))
* fix(L3rd pop-up): filter out properties starting with @ ([c85ebeb](https://github.com/nrkno/tv-automation-server-core/commit/c85ebeb))
* fix(lookahead): RETAIN mode now follows the WHEN_CLEAR behaviour instead of PRELOAD ([f0df41c](https://github.com/nrkno/tv-automation-server-core/commit/f0df41c))
* fix(media manager ui): display work step labels correctly ([05cce78](https://github.com/nrkno/tv-automation-server-core/commit/05cce78))
* fix(media manager ui): fix task list layout issue ([9902dc1](https://github.com/nrkno/tv-automation-server-core/commit/9902dc1))
* fix(media manager ui): media manager flow order ([1eb1c48](https://github.com/nrkno/tv-automation-server-core/commit/1eb1c48))
* fix(media manager): label on MM workFlow ([fc2e8d5](https://github.com/nrkno/tv-automation-server-core/commit/fc2e8d5))
* fix(migrations): Broken StudioContext.updateDevice method ([7311d10](https://github.com/nrkno/tv-automation-server-core/commit/7311d10))
* fix(migrations): DependOnResultFrom id was not being prefixed causing it to never work ([602740c](https://github.com/nrkno/tv-automation-server-core/commit/602740c))
* fix(notifications): change unknown to any ([7ac8008](https://github.com/nrkno/tv-automation-server-core/commit/7ac8008))
* fix(playout): bad timing during autonext ([5524e3b](https://github.com/nrkno/tv-automation-server-core/commit/5524e3b))
* fix(playout): Ensure that infinite segmentLineItems are reset correctly after being removed by some  ([e4f8a83](https://github.com/nrkno/tv-automation-server-core/commit/e4f8a83))
* fix(playout): Ensure that infinite segmentLineItems are reset correctly after being removed by some  ([045c9b1](https://github.com/nrkno/tv-automation-server-core/commit/045c9b1))
* fix(playout): Fix overlap tests ([15628a2](https://github.com/nrkno/tv-automation-server-core/commit/15628a2))
* fix(playout): ID prefixing did not handle logical object id references ([44f2883](https://github.com/nrkno/tv-automation-server-core/commit/44f2883))
* fix(playout): Infinite item continuations were not always updated correctly ([7a7aed6](https://github.com/nrkno/tv-automation-server-core/commit/7a7aed6))
* fix(playout): Objects being written out without an id ([b05a851](https://github.com/nrkno/tv-automation-server-core/commit/b05a851))
* fix(playout): Optimise layers of promises in infinite generation logic, and reorder function paramet ([e400c7c](https://github.com/nrkno/tv-automation-server-core/commit/e400c7c))
* fix(playout): Typo in ID prefixing ([249b35d](https://github.com/nrkno/tv-automation-server-core/commit/249b35d))
* fix(playout): Use original sli id when adding infinite to the timeline, to ensure that any triggers  ([e7eb871](https://github.com/nrkno/tv-automation-server-core/commit/e7eb871))
* fix(playout): Use original sli id when adding infinite to the timeline, to ensure that any triggers  ([c0382ec](https://github.com/nrkno/tv-automation-server-core/commit/c0382ec))
* fix(ro list): translatify & hide 'Unsynced from MOS' label when no unsynced items ([fa56ecd](https://github.com/nrkno/tv-automation-server-core/commit/fa56ecd))
* fix(ro list): translatify & hide 'Unsynced from MOS' label when no unsynced items ([11b0f29](https://github.com/nrkno/tv-automation-server-core/commit/11b0f29))
* feat: add expected media items collection ([931536e](https://github.com/nrkno/tv-automation-server-core/commit/931536e))
* feat: Add LOG_FILE env var to specify the file to log to ([d2ad941](https://github.com/nrkno/tv-automation-server-core/commit/d2ad941))
* feat: Add LOG_FILE env var to specify the file to log to ([8a192bc](https://github.com/nrkno/tv-automation-server-core/commit/8a192bc))
* feat: add nn translation and update nb translation ([922b93b](https://github.com/nrkno/tv-automation-server-core/commit/922b93b))
* feat: add nn-nynorsk and update nb-bokmal translation ([6db7a99](https://github.com/nrkno/tv-automation-server-core/commit/6db7a99))
* feat: add property .deviceId to MediaWorkFlow & MedieWorkFlowStep, to indicate ownership. (prelimina ([62ac066](https://github.com/nrkno/tv-automation-server-core/commit/62ac066))
* feat: add restart button ([9b43d6f](https://github.com/nrkno/tv-automation-server-core/commit/9b43d6f))
* feat: add restart button ([6083145](https://github.com/nrkno/tv-automation-server-core/commit/6083145))
* feat: add stoppedPlayback tracking ([ddbdd66](https://github.com/nrkno/tv-automation-server-core/commit/ddbdd66))
* feat: add stoppedPlayback tracking ([7345856](https://github.com/nrkno/tv-automation-server-core/commit/7345856))
* feat: add support for Config References (to be used for referencing usernames & passwords) ([6df8c6e](https://github.com/nrkno/tv-automation-server-core/commit/6df8c6e))
* feat: add support for refs in rabbitMQ-messages (for username & password) ([e34ee34](https://github.com/nrkno/tv-automation-server-core/commit/e34ee34))
* feat: add support for refs in rabbitMQ-messages (for username & password) ([5b3ea33](https://github.com/nrkno/tv-automation-server-core/commit/5b3ea33))
* feat: Add support for RuntimeArguments in blueprint migrations ([82e5286](https://github.com/nrkno/tv-automation-server-core/commit/82e5286))
* feat: Add support panel in Running Order View ([e3cee77](https://github.com/nrkno/tv-automation-server-core/commit/e3cee77))
* feat: add versions to /health endpoint ([a324213](https://github.com/nrkno/tv-automation-server-core/commit/a324213))
* feat: added Timeline.objectType and implemented the typing changes all around ([a69e626](https://github.com/nrkno/tv-automation-server-core/commit/a69e626))
* feat: allow a string array as mediaFlowIds in SLI content ([7ac6fb5](https://github.com/nrkno/tv-automation-server-core/commit/7ac6fb5))
* feat: black / freeze frame detection warnings ([7166177](https://github.com/nrkno/tv-automation-server-core/commit/7166177))
* feat: cherry-pick changes from the UI feature branch ([dfbb3b4](https://github.com/nrkno/tv-automation-server-core/commit/dfbb3b4))
* feat: componentize WorkFlow item ([f920e4b](https://github.com/nrkno/tv-automation-server-core/commit/f920e4b))
* feat: configuration UI for media manager ([b1883ec](https://github.com/nrkno/tv-automation-server-core/commit/b1883ec))
* feat: create action buttons in the Support PopUp for reset PG, take snapshot, show hotkeys ([be89893](https://github.com/nrkno/tv-automation-server-core/commit/be89893))
* feat: disable shortcut-keys when modalDialog is open ([24bab3f](https://github.com/nrkno/tv-automation-server-core/commit/24bab3f))
* feat: dismiss all notifcations ([896dbb5](https://github.com/nrkno/tv-automation-server-core/commit/896dbb5))
* feat: expected audioTracks property ([250dc79](https://github.com/nrkno/tv-automation-server-core/commit/250dc79))
* feat: implemented userActions ([2b343e6](https://github.com/nrkno/tv-automation-server-core/commit/2b343e6))
* feat: include expectedMediaItems in RunningOrder snapshots ([9fcbba0](https://github.com/nrkno/tv-automation-server-core/commit/9fcbba0))
* feat: Media Manager actions to restart & abort workflows ([6c94ad6](https://github.com/nrkno/tv-automation-server-core/commit/6c94ad6))
* feat: mediamanager: GUI support for SKIPPED step status ([1c39867](https://github.com/nrkno/tv-automation-server-core/commit/1c39867))
* feat: monitor externalMessageQueue for system status ([e92f5be](https://github.com/nrkno/tv-automation-server-core/commit/e92f5be))
* feat: more WIP for support panel ([b23c855](https://github.com/nrkno/tv-automation-server-core/commit/b23c855))
* feat: move delete button to peripheralDevice page ([286d12f](https://github.com/nrkno/tv-automation-server-core/commit/286d12f))
* feat: output evaluation to log ([f95cfbf](https://github.com/nrkno/tv-automation-server-core/commit/f95cfbf))
* feat: output evaluation to log ([7deca0f](https://github.com/nrkno/tv-automation-server-core/commit/7deca0f))
* feat: rabbitMQ: add support for headers ([e3e3d48](https://github.com/nrkno/tv-automation-server-core/commit/e3e3d48))
* feat: rabbitMQ: headers ([087bb2e](https://github.com/nrkno/tv-automation-server-core/commit/087bb2e))
* feat: RunningOrder unsynced notification ([9effce5](https://github.com/nrkno/tv-automation-server-core/commit/9effce5))
* feat: separate RO list into synced and unsynced lists ([6b92f40](https://github.com/nrkno/tv-automation-server-core/commit/6b92f40))
* feat: settings: add workflow linger time ([9beefda](https://github.com/nrkno/tv-automation-server-core/commit/9beefda))
* feat: show 99+ instead of actual number for notifications ([1f84e67](https://github.com/nrkno/tv-automation-server-core/commit/1f84e67))
* feat: SOURCE_NOT_SET for SLI Status ([cff64e1](https://github.com/nrkno/tv-automation-server-core/commit/cff64e1))
* feat: support for multiple notification actions ([09be9c1](https://github.com/nrkno/tv-automation-server-core/commit/09be9c1))
* feat: support media manager integration ([dcbf282](https://github.com/nrkno/tv-automation-server-core/commit/dcbf282))
* feat: Support panel WIP ([6955fdc](https://github.com/nrkno/tv-automation-server-core/commit/6955fdc))
* feat: system-wide message ([d7305df](https://github.com/nrkno/tv-automation-server-core/commit/d7305df))
* feat: this did not look right button ([1e01a10](https://github.com/nrkno/tv-automation-server-core/commit/1e01a10))
* feat: url parameter "all" configures ui modes ([586d5f4](https://github.com/nrkno/tv-automation-server-core/commit/586d5f4))
* feat(expected media items): updateExpectedMediaItems function ([e1ad692](https://github.com/nrkno/tv-automation-server-core/commit/e1ad692))
* feat(expected media items): use segmentLineId as key ([3803e87](https://github.com/nrkno/tv-automation-server-core/commit/3803e87))
* feat(health check): statusMessage implementation ([9bcf95a](https://github.com/nrkno/tv-automation-server-core/commit/9bcf95a))
* feat(hotkeys): optional cool down ([c9c2743](https://github.com/nrkno/tv-automation-server-core/commit/c9c2743))
* feat(Media manager settings): add 'mediaPath' property to storages ([50185b2](https://github.com/nrkno/tv-automation-server-core/commit/50185b2))
* feat(media manager ui): fix animations ([10a38de](https://github.com/nrkno/tv-automation-server-core/commit/10a38de))
* feat(media manager ui): nearly finishing the styling ([1bb3116](https://github.com/nrkno/tv-automation-server-core/commit/1bb3116))
* feat(media manager ui): show workflow creation time ([84a4b71](https://github.com/nrkno/tv-automation-server-core/commit/84a4b71))
* feat(media manager UI): WIP ([ccb54f0](https://github.com/nrkno/tv-automation-server-core/commit/ccb54f0))
* feat(multi-step success): introduce keyStep property ([fc8aebd](https://github.com/nrkno/tv-automation-server-core/commit/fc8aebd))
* feat(onlySelectedFiles): support only selected files flag on shared storage options ([dee11d2](https://github.com/nrkno/tv-automation-server-core/commit/dee11d2))
* feat(playout): Add classes to sl-firstobject from the current and prev sl. This will allow for some  ([632326f](https://github.com/nrkno/tv-automation-server-core/commit/632326f))
* feat(settings): playout devices have threadUsage ([b74410c](https://github.com/nrkno/tv-automation-server-core/commit/b74410c))
* feature: implement userActions (wip) ([c0345e0](https://github.com/nrkno/tv-automation-server-core/commit/c0345e0))
* Feat: support custom notification timeouts ([d4cf9d4](https://github.com/nrkno/tv-automation-server-core/commit/d4cf9d4))
