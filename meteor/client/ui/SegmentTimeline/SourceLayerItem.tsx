	...
	> {
		...
		toggleMiniInspector = (e: MouseEvent | any, v: boolean) => {
			...
			const cursorTimePosition =
				Math.max(cursorPosition.left, 0) / this.props.timeScale;
		...
		render() {
			if (this.isInsideViewport()) {
				...
				const typeClass = RundownUtils.getSourceLayerClassName(
				...
				return (
					<div
						...
						onMouseOver={(e) =>
							!this.props.outputGroupCollapsed &&
							this.toggleMiniInspector(e, true)
						}
