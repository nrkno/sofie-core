...
export class CustomLayerItemRenderer<IProps = any, IState = any> extends React.Component<ISourceLayerItemProps & IProps, IState> {
	...
	renderInfiniteIcon () {
		return (this.props.segmentLineItem.infiniteMode && this.props.segmentLineItem.infiniteMode !== SegmentLineItemLifespan.OutOnNextSegmentLine && !this.props.segmentLineItem.duration && !this.props.segmentLineItem.durationOverride) ?
