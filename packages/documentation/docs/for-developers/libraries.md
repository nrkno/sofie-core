...
* [**Input Gateway**](https://github.com/nrkno/tv-automation-input-gateway) _(Work in progress)_ 
...
* [**CasparCG Connection**](https://github.com/SuperFlyTV/casparcg-connection) *developed by [SuperFly.tv](https://github.com/SuperFlyTV)* Library to connect and interact with CasparCG Servers.
