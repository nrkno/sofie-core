import { ClientAPI, ClientAPIMethods, NewClientAPI } from '../../lib/api/client'
...
import { getCurrentTime, getRandomId, isPromise, literal, makePromise, Time, waitForPromise } from '../../lib/lib'
