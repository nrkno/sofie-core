...
>((props: IDeviceSettingsProps) => {
	...
	class DeviceSettings extends MeteorReactComponent<
		Translated<IDeviceSettingsProps & IDeviceSettingsTrackedProps>
	> {
		renderSpecifics() {
			if (
				this.props.device &&
				...
				switch (this.props.device.type) {
					...
					case PeripheralDeviceAPI.DeviceType.PLAYOUT:
						return (
							<PlayoutDeviceSettingsComponent
								device={this.props.device}
								subDevices={this.props.subDevices}
							/>
						);
