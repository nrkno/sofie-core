...
* chore: cherry-pick additional fix for numpad enter ([5d44383](https://github.com/nrkno/tv-automation-server-core/commit/5d44383))
...
* Merge branch 'develop' into feature/panasonic-ptz ([39eb523](https://github.com/nrkno/tv-automation-server-core/commit/39eb523))
...
* Merge remote-tracking branch 'origin/feature/panasonic-ptz' into develop ([036370a](https://github.com/nrkno/tv-automation-server-core/commit/036370a))
...
* Merge remote-tracking branch 'origin/release2' into develop ([bf7efd1](https://github.com/nrkno/tv-automation-server-core/commit/bf7efd1))
...
* feat: optimization: add cache of blueprints, to avoid having to parse text-functions all the time ([1e469d9](https://github.com/nrkno/tv-automation-server-core/commit/1e469d9))



<a name="0.15.0-hotfix-enter-key"></a>
## 0.15.0-hotfix-enter-key (2018-10-16)
...
* fix:Renamed warning icon file and references. ([bf2edfe](https://github.com/nrkno/tv-automation-server-core/commit/bf2edfe))
* fix:reset disabled flag on SL and RO reset ([8f69f67](https://github.com/nrkno/tv-automation-server-core/commit/8f69f67))
* Merge branch 'develop' into feature/click-to-adlib ([dd09adb](https://github.com/nrkno/tv-automation-server-core/commit/dd09adb))
* Merge branch 'develop' into feature/click-to-adlib ([a61d3df](https://github.com/nrkno/tv-automation-server-core/commit/a61d3df))
* Merge branch 'develop' into feature/click-to-adlib ([c52da89](https://github.com/nrkno/tv-automation-server-core/commit/c52da89))
* Merge branch 'develop' into feature/panasonic-ptz ([42df69c](https://github.com/nrkno/tv-automation-server-core/commit/42df69c))
* Merge branch 'develop' of github.com:nrkno/tv-automation-server-core into develop ([4ab392e](https://github.com/nrkno/tv-automation-server-core/commit/4ab392e))
* Merge branch 'develop' of github.com:nrkno/tv-automation-server-core into develop ([4f69793](https://github.com/nrkno/tv-automation-server-core/commit/4f69793))
* Merge branch 'feature/optimize2' into develop ([d8e16c4](https://github.com/nrkno/tv-automation-server-core/commit/d8e16c4))
* Merge branch 'master' into develop ([9d0da8c](https://github.com/nrkno/tv-automation-server-core/commit/9d0da8c))
* Merge branch 'release2' into develop ([1809d75](https://github.com/nrkno/tv-automation-server-core/commit/1809d75))
* merge in mouseTraphelper fix for broken enter-shortcut from develop into release 2 ([80b841e](https://github.com/nrkno/tv-automation-server-core/commit/80b841e))
...
* feat: implement spliting long scripts into beginning and end in popup ([9fa8006](https://github.com/nrkno/tv-automation-server-core/commit/9fa8006))
...
* feat: use default renderer for MIC sourceLayerType ([6ab97b7](https://github.com/nrkno/tv-automation-server-core/commit/6ab97b7))
...
* chore: change prerelease script name so its not picked up automatically by jenkins ([9057396](https://github.com/nrkno/tv-automation-server-core/commit/9057396))
...
* chore: cherry-pick guest segments feature ([3772e90](https://github.com/nrkno/tv-automation-server-core/commit/3772e90))
...
* chore: merge fix from develop ([45b7fae](https://github.com/nrkno/tv-automation-server-core/commit/45b7fae))
...
* fix: activate past ROs ([c20af5d](https://github.com/nrkno/tv-automation-server-core/commit/c20af5d))
...
* fix: also defer sendStoryStatus, as that's not critical for playback ([9417862](https://github.com/nrkno/tv-automation-server-core/commit/9417862))
* fix: be able to reset & activate inactivated RO ([e7d52da](https://github.com/nrkno/tv-automation-server-core/commit/e7d52da))
* fix: be able to reset & activate inactivated RO ([18e01f4](https://github.com/nrkno/tv-automation-server-core/commit/18e01f4))
...
* fix: defer triggerExternalMessage so as not to block timelineUpdate's ([ba7383f](https://github.com/nrkno/tv-automation-server-core/commit/ba7383f))
...
* fix: improved queries & added index ([159f6d5](https://github.com/nrkno/tv-automation-server-core/commit/159f6d5))
...
* fix: optimize saveIntoDB ([65c189e](https://github.com/nrkno/tv-automation-server-core/commit/65c189e))
...
* fix: resetRunningorder should update timeline ([35451b1](https://github.com/nrkno/tv-automation-server-core/commit/35451b1))
...
* fix: setAsNext on previous ([4ffe665](https://github.com/nrkno/tv-automation-server-core/commit/4ffe665))
...
* fix: Use thin styling for a solo 'AUTO' label ([0c26d38](https://github.com/nrkno/tv-automation-server-core/commit/0c26d38))
...
* fix(lookahead): Dont run lookahead on abs0 sli if there is an active transition. ([bb4123a](https://github.com/nrkno/tv-automation-server-core/commit/bb4123a))
...
* fix(lookahead): Fix lookahead when transition object starts at abs0 ([c88c830](https://github.com/nrkno/tv-automation-server-core/commit/c88c830))
