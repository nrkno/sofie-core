...
import {
	IPlayoutDeviceSettingsComponentProps,
	IPlayoutDeviceSettingsComponentState,
} from './IHttpSendDeviceSettingsComponentProps'
import { getHelpMode } from '../../../lib/localStorage'
import { TSR } from 'tv-automation-sofie-blueprints-integration'
import { protectString, unprotectString } from '../../../../lib/lib'

export const PlayoutDeviceSettingsComponent = translate()(
	class PlayoutDeviceSettingsComponent extends React.Component<
				...
				<table className="expando settings-studio-device-table">
					<tbody>
						...
						{_.map(settings.devices, (subDevice: TSR.DeviceOptionsAny, deviceId0: string) => {
							...
							return (
								<React.Fragment key={deviceId0}>
									<tr
										className={ClassNames({
											hl: this.isItemEdited(deviceId),
										})}>
										<th className="settings-studio-device__name c5">{deviceId}</th>
										<td className="settings-studio-device__id c4">{TSR.DeviceType[subDevice.type]}</td>
										<td className="settings-studio-device__id c2 alc">
											<EditAttribute
												modifiedClassName="bghl"
												attribute={'settings.devices.' + deviceId + '.disable'}
				...
				<React.Fragment>
					...
					<div className="mod mvs mhs">
						<label className="field">
							...
							<EditAttribute
								modifiedClassName="bghl"
								attribute={'settings.devices.' + deviceId + '.options.bufferEncoding'}
								obj={this.props.device}
								type="text"
								collection={PeripheralDevices}
								className="input text-input input-l"></EditAttribute>
				...
				<React.Fragment>
					...
					<div className="mod mvs mhs">
						<label className="field">
							...
							<EditAttribute
								modifiedClassName="bghl"
								attribute={'settings.devices.' + deviceId + '.options.minRecordingTime'}
								obj={this.props.device}
								type="int"
								collection={PeripheralDevices}
								className="input text-input input-l"></EditAttribute>
				...
				<React.Fragment>
					...
					<div className="mod mvs mhs">
						<label className="field">
							...
							<EditAttribute
								modifiedClassName="bghl"
								attribute={'settings.devices.' + deviceId + '.options.httpMethod'}
								obj={this.props.device}
								type="text"
								collection={PeripheralDevices}
								className="input text-input input-l"></EditAttribute>
					...
					<div className="mod mvs mhs">
						<label className="field">
							...
							<EditAttribute
								modifiedClassName="bghl"
								attribute={'settings.devices.' + deviceId + '.options.expectedHttpResponse'}
								obj={this.props.device}
								type="int"
								collection={PeripheralDevices}
								className="input text-input input-l"></EditAttribute>
				...
				<React.Fragment>
					<div className="mod mvs mhs">
						<label className="field">
							...
							<EditAttribute
								modifiedClassName="bghl"
								attribute={'settings.devices.' + deviceId + '.options.gatewayUrl'}
								obj={this.props.device}
								type="text"
								collection={PeripheralDevices}
								className="input text-input input-l"></EditAttribute>
				...
				<React.Fragment>
					...
					<div className="mod mvs mhs">
						<label className="field">
							...
							<EditAttribute
								modifiedClassName="bghl"
								attribute={'settings.devices.' + deviceId + '.options.restPort'}
								obj={this.props.device}
								type="int"
								collection={PeripheralDevices}
								className="input text-input input-l"></EditAttribute>
					...
					<div className="mod mvs mhs">
						<label className="field">
							...
							<EditAttribute
								modifiedClassName="bghl"
								attribute={'settings.devices.' + deviceId + '.options.wsPort'}
								obj={this.props.device}
								type="int"
								collection={PeripheralDevices}
								className="input text-input input-l"></EditAttribute>
					...
					<div className="mod mvs mhs">
						<label className="field">
							...
							<EditAttribute
								modifiedClassName="bghl"
								attribute={'settings.devices.' + deviceId + '.options.showID'}
								obj={this.props.device}
								type="text"
								collection={PeripheralDevices}
								className="input text-input input-l"></EditAttribute>
					...
					<div className="mod mvs mhs">
						<label className="field">
							...
							<EditAttribute
								modifiedClassName="bghl"
								attribute={'settings.devices.' + deviceId + '.options.profile'}
								obj={this.props.device}
								type="text"
								collection={PeripheralDevices}
								className="input text-input input-l"></EditAttribute>
					...
					<div className="mod mvs mhs">
						<label className="field">
							...
							<EditAttribute
								modifiedClassName="bghl"
								attribute={'settings.devices.' + deviceId + '.options.playlistID'}
								obj={this.props.device}
								type="text"
								collection={PeripheralDevices}
								className="input text-input input-l"></EditAttribute>
					...
					<div className="mod mvs mhs">
						<label className="field">
							...
							<EditAttribute
								modifiedClassName="bghl"
								attribute={'settings.devices.' + deviceId + '.options.preloadAllElements'}
								obj={this.props.device}
								type="checkbox"
								collection={PeripheralDevices}
								className="input"></EditAttribute>
					...
					<div className="mod mvs mhs">
						<label className="field">
							...
							<EditAttribute
								modifiedClassName="bghl"
								attribute={'settings.devices.' + deviceId + '.options.autoLoadInternalElements'}
								obj={this.props.device}
								type="checkbox"
								collection={PeripheralDevices}
								className="input"></EditAttribute>
					...
					<div className="mod mvs mhs">
						<label className="field">
							...
							<EditAttribute
								modifiedClassName="bghl"
								attribute={'settings.devices.' + deviceId + '.options.clearAllTemplateName'}
								obj={this.props.device}
								type="text"
								collection={PeripheralDevices}
								className="input"></EditAttribute>
					...
					<div className="mod mvs mhs">
						<label className="field">
							...
							<EditAttribute
								modifiedClassName="bghl"
								attribute={'settings.devices.' + deviceId + '.options.clearAllOnMakeReady'}
								obj={this.props.device}
								type="checkbox"
								collection={PeripheralDevices}
								className="input"></EditAttribute>
					...
					<div className="mod mvs mhs">
						<label className="field">
							...
							<EditAttribute
								modifiedClassName="bghl"
								attribute={'settings.devices.' + deviceId + '.options.dontDeactivateOnStandDown'}
								obj={this.props.device}
								type="checkbox"
								collection={PeripheralDevices}
								className="input"></EditAttribute>
					...
					<div className="mod mvs mhs">
						<label className="field">
							...
							<EditAttribute
								modifiedClassName="bghl"
								attribute={'settings.devices.' + deviceId + '.options.onlyPreloadActiveRundown'}
								obj={this.props.device}
								type="checkbox"
								collection={PeripheralDevices}
								className="input"></EditAttribute>
					...
					<div className="mod mvs mhs">
						<label className="field">
							...
							<EditAttribute
								modifiedClassName="bghl"
								attribute={'settings.devices.' + deviceId + '.options.initializeRundownOnLoadAll'}
								obj={this.props.device}
								type="checkbox"
								collection={PeripheralDevices}
								className="input"></EditAttribute>
				...
				<div>
					...
					<div>
						<label className="field">
							...
							<EditAttribute
								modifiedClassName="bghl"
								attribute={'settings.reportAllCommands'}
								obj={this.props.device}
								type="checkbox"
								collection={PeripheralDevices}
								className=""></EditAttribute>
					...
					<ModalDialog
						...
						<p>
							{t('Are you sure you want to remove device "{{deviceId}}"?', {
								deviceId: this.state.deleteConfirmDeviceId && this.state.deleteConfirmDeviceId,
							})}
						</p>
