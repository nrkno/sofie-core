...
export class ManualPlayout extends MeteorReactComponent<IManualPlayoutProps, IManualPlayoutState> {
	...
	casparcgClear(e: React.MouseEvent<HTMLElement>, studio: Studio, mappingLayerId: string) {
		callMethod(
			e,
			ManualPlayoutAPI.methods.removeTimelineObject,
			studio._id,
			'caspar_' + mappingLayerId
		);
	}
													...
													return (
														<td key={cam}>
															<button
																...
																onClick={(e) => this.atemCamera(e, studio, mappingLayerId, cam)}>
																Camera {cam}
															</button>
														</td>
													);
											...
											return (
												<tr key={mappingLayerId}>
													...
													<td>
														<button
															className="btn btn-primary"
															onClick={(e) => this.casparcgPlay(e, studio, mappingLayerId)}>
															Caspar Play
														</button>
														<button
															className="btn btn-primary"
															onClick={(e) => this.casparcgClear(e, studio, mappingLayerId)}>
															Clear
														</button>
													</td>
													<td>
														<EditAttribute
															updateFunction={(_edit, value) =>
																this.onInputChange(mappingLayerId, 'file', value)
															}
															type="text"
											...
											return (
												<tr key={mappingLayerId}>
													...
													<td>
														<button
															className="btn btn-primary"
															onClick={(e) => this.quantelPlay(e, studio, mappingLayerId)}>
															Quantel Play
														</button>
														<button
															className="btn btn-primary"
															onClick={(e) => this.quantelClear(e, studio, mappingLayerId)}>
															Clear
														</button>
													</td>
													<td>
														<EditAttribute
															updateFunction={(_edit, value) =>
																this.onInputChange(mappingLayerId, 'title', value)
															}
															type="text"
															overrideDisplayValue={
																(this.state.inputValues[mappingLayerId] || {}).title
															}
														/>
													</td>
													<td>
														<EditAttribute
															updateFunction={(_edit, value) =>
																this.onInputChange(mappingLayerId, 'guid', value)
															}
															type="text"
															overrideDisplayValue={
																(this.state.inputValues[mappingLayerId] || {}).guid
															}
														/>
													</td>
												</tr>
