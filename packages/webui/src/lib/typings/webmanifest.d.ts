/* tslint:disable */
/**
 * This file was automatically generated by json-schema-to-typescript and then manually extended to support new
 * WebAPIs. See Fugu project: https://fugu-tracker.web.app/
 * Source: https://json.schemastore.org/web-manifest.json
 */

type BasicDisplayMode = 'fullscreen' | 'standalone' | 'minimal-ui' | 'browser'
type ExtendedDisplayMode = BasicDisplayMode | 'window-controls-overlay' | 'tabbed'
...
export interface JSONSchemaForWebApplicationManifestFiles {
	 ...
	 */
	display?: BasicDisplayMode
	/**
	 * This item represents additional developer's preferred display modes, in order of preference. If none of them are available, display will be used
	 * See: https://developer.mozilla.org/en-US/docs/Web/Manifest/display_override
	 */
	display_override?: ExtendedDisplayMode[]
	/**
	...
	id?: string
	/**
	 * A list of protocol Web Handlers to be registered when installing this app.
	 * See: https://web.dev/url-protocol-handler/#how-to-use-url-protocol-handler-registration-for-pwas
	 */
