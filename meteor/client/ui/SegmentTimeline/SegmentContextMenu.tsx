...
export const SegmentContextMenu = translate()(
	class extends React.Component<Translated<IProps>, IState> {
		...
		render() {
			...
			return this.props.studioMode && this.props.rundown && this.props.rundown.active ? (
				<Escape to="document">
					<ContextMenu id="segment-timeline-context-menu">
						{part && !part.invalid && timecode !== null && (
							<React.Fragment>
								{startsAt !== null && (
									<MenuItem
		...
		private getSLStartsAt = (): number | null => {
			if (
				...
				this.props.contextMenuContext.partStartsAt !== undefined
			) {
