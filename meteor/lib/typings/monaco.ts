...
declare namespace monaco {
	...
	export namespace languages.typescript {
		...
		export let typescriptDefaults: LanguageServiceDefaults
		export let javascriptDefaults: LanguageServiceDefaults

		export let getTypeScriptWorker: () => Promise<any>
		export let getJavaScriptWorker: () => Promise<any>
	}
	...
	*--------------------------------------------------------------------------------------------*/
	export namespace languages.css {
		...
		export let cssDefaults: LanguageServiceDefaults
		export let lessDefaults: LanguageServiceDefaults
		export let scssDefaults: LanguageServiceDefaults
	}
	/*---------------------------------------------------------------------------------------------
	*  Copyright (c) Microsoft Corporation. All rights reserved.
	*  Licensed under the MIT License. See License.txt in the project root for license information.
	*--------------------------------------------------------------------------------------------*/
	...
	export namespace languages.json {
		...
		export let jsonDefaults: LanguageServiceDefaults
	}
	/*---------------------------------------------------------------------------------------------
	*  Copyright (c) Microsoft Corporation. All rights reserved.
	*  Licensed under the MIT License. See License.txt in the project root for license information.
	*--------------------------------------------------------------------------------------------*/
	...
	export namespace languages.html {
		...
		export let htmlDefaults: LanguageServiceDefaults
		export let handlebarDefaults: LanguageServiceDefaults
