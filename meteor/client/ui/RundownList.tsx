import { faSync, faTrash, IconName } from '@fortawesome/free-solid-svg-icons'
...
import { getAllowConfigure, getAllowDeveloper, getAllowService, getHelpMode } from '../lib/localStorage'
