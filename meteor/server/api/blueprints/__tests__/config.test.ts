...
describe('Test blueprint config', () => {
	...
	describe('retrieveRefs', () => {
		...
		test('undefined - normal', () => {
			...
			expect(ConfigRef.retrieveRefs('${studio.one.two}_extra', modifier)).toEqual(
				'undefined_extra'
			);
			expect(ConfigRef.retrieveRefs('${showStyle.one.two}_extra', modifier)).toEqual(
				'undefined_extra'
			);
		...
		test('undefined - bail', () => {
			...
			try {
				expect(ConfigRef.retrieveRefs('${studio.one.two}_extra', modifier, true)).toEqual(
					'undefined_extra'
				);
