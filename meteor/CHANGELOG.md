...
* apply some fixes when restoring a rundown ([b04bf53](https://github.com/nrkno/tv-automation-server-core/commit/b04bf53))
...
* do not refresh rundown notifications if rundown/showStyleBase/studio changes ([5702939](https://github.com/nrkno/tv-automation-server-core/commit/5702939))
...
* optimizations in rundownTake ([3457e73](https://github.com/nrkno/tv-automation-server-core/commit/3457e73))
...
* resolve issue with partDisplayDuration & segment duration ([a73ed09](https://github.com/nrkno/tv-automation-server-core/commit/a73ed09))
* rundown config changed notification not updating when rundown is updated ([f5c2540](https://github.com/nrkno/tv-automation-server-core/commit/f5c2540))
* Rundown status notifying wrong dep ([e6b84e5](https://github.com/nrkno/tv-automation-server-core/commit/e6b84e5))
...
* Update rundown change notification on an interval, to ensure it catches changes to other document ty ([79d8c05](https://github.com/nrkno/tv-automation-server-core/commit/79d8c05))
...
* use floor for all positioning and sizing of parts ([8a84a7e](https://github.com/nrkno/tv-automation-server-core/commit/8a84a7e))
* when restoring a rundown, use the .active property of the database (or false) ([b5e5b05](https://github.com/nrkno/tv-automation-server-core/commit/b5e5b05))
...
* backup: make restore rundown less strict ([e78313f](https://github.com/nrkno/tv-automation-server-core/commit/e78313f))
...
* delete & sync buttons in rundown-list ([9fbc875](https://github.com/nrkno/tv-automation-server-core/commit/9fbc875))
...
* lookahead: Give lookahead the correct limit when in the next Part during autonext ([a3a299a](https://github.com/nrkno/tv-automation-server-core/commit/a3a299a))
...
* chore: Don't log when rundownNeedsUpdating is called ([450c9e6](https://github.com/nrkno/tv-automation-server-core/commit/450c9e6))
...
* chore: refactor view when rundown not loaded properly ([0a5c509](https://github.com/nrkno/tv-automation-server-core/commit/0a5c509))
...
* Add missing _rank field to AdLibPiece ([9cd15fa](https://github.com/nrkno/tv-automation-server-core/commit/9cd15fa))
...
* Add missing layers to initdb. Use readtime as possible duration of part when calculating story length ([e388d63](https://github.com/nrkno/tv-automation-server-core/commit/e388d63))
...
* allow duration 0 of parts ([11a18ae](https://github.com/nrkno/tv-automation-server-core/commit/11a18ae))
* allow esc & enter in modalDialog ([cd511b6](https://github.com/nrkno/tv-automation-server-core/commit/cd511b6))
* allow re-sync of unsynced rundown while it is active ([b824d72](https://github.com/nrkno/tv-automation-server-core/commit/b824d72))
...
* always rewind GUI on rundownReset, rundownResetAndActivate ([4502d90](https://github.com/nrkno/tv-automation-server-core/commit/4502d90))
* always rewind GUI on rundownReset, rundownResetAndActivate ([11744c9](https://github.com/nrkno/tv-automation-server-core/commit/11744c9))
...
* be able to reset & activate inactivated rundown ([18e01f4](https://github.com/nrkno/tv-automation-server-core/commit/18e01f4))
* be able to reset & activate inactivated rundown ([e7d52da](https://github.com/nrkno/tv-automation-server-core/commit/e7d52da))
...
* BIG optimization in rundownTake and affected functions, made database fetches async & parallel where possible. This should not affect the functionality, though testing is needed. ([aa6f4bd](https://github.com/nrkno/tv-automation-server-core/commit/aa6f4bd))
...
* broken GUI Pieces resolution, when simulating timeline output ([60fb843](https://github.com/nrkno/tv-automation-server-core/commit/60fb843))
...
* bugfix: didn't correctly find the right piece in next part ([0f9313f](https://github.com/nrkno/tv-automation-server-core/commit/0f9313f))
* bugfix: executeFunction didn't really time out ([acba08c](https://github.com/nrkno/tv-automation-server-core/commit/acba08c))
* bugfix: timeline wasn't updated when going rehersal => rundownResetAndActivate ([ca76732](https://github.com/nrkno/tv-automation-server-core/commit/ca76732))
...
* bugfix: updateExpectedMediaItems used all pieces in rundown, not just in segmmentLine ([406829b](https://github.com/nrkno/tv-automation-server-core/commit/406829b))
...
* clean up more collections when removing rundown ([b84ed59](https://github.com/nrkno/tv-automation-server-core/commit/b84ed59))
* clean up onBeforeUnload handler ([51adbba](https://github.com/nrkno/tv-automation-server-core/commit/51adbba))
* clear queued adlibs when resetting rundown ([83ed11a](https://github.com/nrkno/tv-automation-server-core/commit/83ed11a))
* clear runtimeArguments on resetRundown ([350dd45](https://github.com/nrkno/tv-automation-server-core/commit/350dd45))
...
* disable client-side rundown updates ([72ba831](https://github.com/nrkno/tv-automation-server-core/commit/72ba831))
...
* do not allow toggling part arguments during hold mode ([3311f0a](https://github.com/nrkno/tv-automation-server-core/commit/3311f0a))
...
* don't send devicesMakeReady until verified no other rundowns are active ([953a1a7](https://github.com/nrkno/tv-automation-server-core/commit/953a1a7))
...
* Dont generate ui outputlayers for piece which are virtual ([c0ad368](https://github.com/nrkno/tv-automation-server-core/commit/c0ad368))
...
* ensure the same overlap is used for autonext and the previous part ([efb39e6](https://github.com/nrkno/tv-automation-server-core/commit/efb39e6))
* Ensure the part overlapDuration is respected on autonext. ([8c3bf3e](https://github.com/nrkno/tv-automation-server-core/commit/8c3bf3e))
* Ensure typeVariant on Part is preserved when a rundownList is received ([98b224c](https://github.com/nrkno/tv-automation-server-core/commit/98b224c))
...
* fix Part notifications ([3753250](https://github.com/nrkno/tv-automation-server-core/commit/3753250))
...
* Guard against there being no next part ([849d97f](https://github.com/nrkno/tv-automation-server-core/commit/849d97f))
* GUI externalMessages json formatting ([0b7cd2c](https://github.com/nrkno/tv-automation-server-core/commit/0b7cd2c))
* GUI: new try on rewinding the viewport on rundown reset ([b0edaf4](https://github.com/nrkno/tv-automation-server-core/commit/b0edaf4))
...
* handle both update & insert of rundown ([3701bb3](https://github.com/nrkno/tv-automation-server-core/commit/3701bb3))
* handle both update & insert of rundown ([84a6c53](https://github.com/nrkno/tv-automation-server-core/commit/84a6c53))
...
* hold-copy of the piece should provide seek information to offset markers on the piece ([3967d03](https://github.com/nrkno/tv-automation-server-core/commit/3967d03))
...
* hot fix for rehearsal activation when an rundown is already active ([648c02d](https://github.com/nrkno/tv-automation-server-core/commit/648c02d))
...
* Importing of some mock rundowns ([eadf225](https://github.com/nrkno/tv-automation-server-core/commit/eadf225))
...
* infinite part tidying and fixes ([8469ffb](https://github.com/nrkno/tv-automation-server-core/commit/8469ffb))
* Infinite part bad guard when calculating the current infinites that caused the process to stop early ([2f9abeb](https://github.com/nrkno/tv-automation-server-core/commit/2f9abeb))
* infinite parts crossing an autonext throwing a duplicate key exception ([93b2a30](https://github.com/nrkno/tv-automation-server-core/commit/93b2a30))
...
* issue with rundownPrepareForBroadcast ([c3ad30c](https://github.com/nrkno/tv-automation-server-core/commit/c3ad30c))
* issue with source layers marked as used even though they were used in the following part ([71acfb3](https://github.com/nrkno/tv-automation-server-core/commit/71acfb3))
...
* limit db fetches to active rundown ([f3aca8f](https://github.com/nrkno/tv-automation-server-core/commit/f3aca8f))
...
* notification equality check, resolves 'republished' rundown notifications ([27b6102](https://github.com/nrkno/tv-automation-server-core/commit/27b6102))
...
* peripheralDevices subscription for rundown data ([90b4e13](https://github.com/nrkno/tv-automation-server-core/commit/90b4e13))
* Persist Part.updateStoryStatus ([427b24c](https://github.com/nrkno/tv-automation-server-core/commit/427b24c))
...
* queued adlib should have infinite piece's ([75452dc](https://github.com/nrkno/tv-automation-server-core/commit/75452dc))
...
* refactored reset-part further ([0523eb6](https://github.com/nrkno/tv-automation-server-core/commit/0523eb6))
...
* remove expectedMediaItems when rundown is removed ([5230695](https://github.com/nrkno/tv-automation-server-core/commit/5230695))
...
* **rundown list:** translatify & hide 'Unsynced from MOS' label when no unsynced items ([fa56ecd](https://github.com/nrkno/tv-automation-server-core/commit/fa56ecd))
...
* rename rundownAPI => rundownAPI ([89d48d0](https://github.com/nrkno/tv-automation-server-core/commit/89d48d0))
* rename version 0.20.0 => 0.21.0 (release 6) ([7b1ee3a](https://github.com/nrkno/tv-automation-server-core/commit/7b1ee3a))
* resetRundown functionality in GUI ([4eb096a](https://github.com/nrkno/tv-automation-server-core/commit/4eb096a))
* resetRundown should update timeline ([0d01e6a](https://github.com/nrkno/tv-automation-server-core/commit/0d01e6a))
* resetRundown should update timeline ([35451b1](https://github.com/nrkno/tv-automation-server-core/commit/35451b1))
* resetting rundown rewind ([a122f2c](https://github.com/nrkno/tv-automation-server-core/commit/a122f2c))
* resolve a typo in rabbitMQ.ts ([3b36ae3](https://github.com/nrkno/tv-automation-server-core/commit/3b36ae3))
* resolve issue with ContextMenus in rundown view ([8d9ba96](https://github.com/nrkno/tv-automation-server-core/commit/8d9ba96))
...
* Respect disableOutTransition on Part during manual takes (not just autonext) ([f19788d](https://github.com/nrkno/tv-automation-server-core/commit/f19788d))
* restore blueprint settings page ([faa7fdd](https://github.com/nrkno/tv-automation-server-core/commit/faa7fdd))
* restore rundown 'backup' fails if doesnt already exist ([87b3300](https://github.com/nrkno/tv-automation-server-core/commit/87b3300))
...
* rundown buttons z-order ([3c53254](https://github.com/nrkno/tv-automation-server-core/commit/3c53254))
* rundown buttons z-order ([15e9da8](https://github.com/nrkno/tv-automation-server-core/commit/15e9da8))
* rundown notification action ([36cf900](https://github.com/nrkno/tv-automation-server-core/commit/36cf900))
* **adlib:** Allow for overlap of adlib piece to give preload time ([d2f0dcd](https://github.com/nrkno/tv-automation-server-core/commit/d2f0dcd))
* **adlib:** An adlib replacing the main piece of a part would not adjust the length of the original. F5/F6 sometimes failed to insert a piece correctly, causing black ([fca6f05](https://github.com/nrkno/tv-automation-server-core/commit/fca6f05))
* **adlib:** Set as next on part after using F5/F6 would not restore correctly ([3829293](https://github.com/nrkno/tv-automation-server-core/commit/3829293))
...
* **hold:** Ensure the original stk does not get picked up as a dynamic object when setting the part as next ([b10f48d](https://github.com/nrkno/tv-automation-server-core/commit/b10f48d))
* **hold:** Ensure the original stk does not get picked up as a dynamic object when setting the part as next ([225304d](https://github.com/nrkno/tv-automation-server-core/commit/225304d))
* **hold:** Ensure the original stk does not get picked up as a dynamic object when setting the part as next ([22da4d8](https://github.com/nrkno/tv-automation-server-core/commit/22da4d8))
* **hold:** keep showing any infinite items that existed on the previous part ([21a9973](https://github.com/nrkno/tv-automation-server-core/commit/21a9973))
* **hold:** Too many piece being extended for hold mode ([f644e32](https://github.com/nrkno/tv-automation-server-core/commit/f644e32))
* **hold:** When extending a piece during hold, use the original id to make any triggers on the piece work ([a3fd1a6](https://github.com/nrkno/tv-automation-server-core/commit/a3fd1a6))
* **hold:** When extending a piece during hold, use the original id to make any triggers on the piece work ([669a4b2](https://github.com/nrkno/tv-automation-server-core/commit/669a4b2))
...
* **Init:** Sets init defaults to xprundown ([fd9c182](https://github.com/nrkno/tv-automation-server-core/commit/fd9c182))
...
* **lookahead:** Dont run lookahead on abs0 piece if there is an active transition. ([191df09](https://github.com/nrkno/tv-automation-server-core/commit/191df09))
* **lookahead:** Dont run lookahead on abs0 piece if there is an active transition. ([bb4123a](https://github.com/nrkno/tv-automation-server-core/commit/bb4123a))
...
* **lookahead:** Ignore transition if this is the first part and so no transition will be used ([3df2e1e](https://github.com/nrkno/tv-automation-server-core/commit/3df2e1e))
* **lookahead:** Not using transition info when in a part with no previous part ([917b34e](https://github.com/nrkno/tv-automation-server-core/commit/917b34e))
...
* **notification center:** fix notification center toggle button in rundown view ([894c1e2](https://github.com/nrkno/tv-automation-server-core/commit/894c1e2))
* **notification center:** fix rundown overview to line up with the Segments column ([0906cab](https://github.com/nrkno/tv-automation-server-core/commit/0906cab))
* **notification center:** notification count position ([1d8d2cb](https://github.com/nrkno/tv-automation-server-core/commit/1d8d2cb))
* **notification center:** reintroduce RundownNotifier into RundownView ([e70e5c9](https://github.com/nrkno/tv-automation-server-core/commit/e70e5c9))
...
* **playout:** Ensure that infinite pieces are reset correctly after being removed by some hotkeys ([045c9b1](https://github.com/nrkno/tv-automation-server-core/commit/045c9b1))
* **playout:** Ensure that infinite pieces are reset correctly after being removed by some hotkeys ([e4f8a83](https://github.com/nrkno/tv-automation-server-core/commit/e4f8a83))
...
* **playout:** R4 only partial merge of dc249a31b342e8bdbeb7faac064dd97cec15c3e8. Fix part duration with autonext and no transitions ([17175c3](https://github.com/nrkno/tv-automation-server-core/commit/17175c3))
...
* **playout:** part with autoNextOverlap not getting applied properly ([eb22967](https://github.com/nrkno/tv-automation-server-core/commit/eb22967))
* rundown Notifications fixes attempt no. 3 ([f0eee1f](https://github.com/nrkno/tv-automation-server-core/commit/f0eee1f))
* rundown overview crashed during rebuild of rundown ([d2c62a1](https://github.com/nrkno/tv-automation-server-core/commit/d2c62a1))
* rundown-reset does not reset properly ([6367658](https://github.com/nrkno/tv-automation-server-core/commit/6367658))
* rundownReset should reset holdItems and infinites ([bdf8385](https://github.com/nrkno/tv-automation-server-core/commit/bdf8385))
...
* rundown closing prompt ([7074cc3](https://github.com/nrkno/tv-automation-server-core/commit/7074cc3))
* rundown closing prompt ([3024543](https://github.com/nrkno/tv-automation-server-core/commit/3024543))
* Rundown Notifications in activeRundown view ([63658b1](https://github.com/nrkno/tv-automation-server-core/commit/63658b1))
* rundown view notifications in production build ([b593323](https://github.com/nrkno/tv-automation-server-core/commit/b593323))
* separate warnings for black frames & freeze frames ([e2acad5](https://github.com/nrkno/tv-automation-server-core/commit/e2acad5))
* Set KAM source layer, and a probably incorrect duration (but its now non-zerundown) ([6e152f0](https://github.com/nrkno/tv-automation-server-core/commit/6e152f0))
...
* show connected devices in rundown view ([e804d1e](https://github.com/nrkno/tv-automation-server-core/commit/e804d1e))
...
* part prod init ([2ff4a46](https://github.com/nrkno/tv-automation-server-core/commit/2ff4a46))
...
* Studio key-value config tidying ([4b0bc1a](https://github.com/nrkno/tv-automation-server-core/commit/4b0bc1a))
* styling fix for z-order with menu and rundown buttons ([1b0717e](https://github.com/nrkno/tv-automation-server-core/commit/1b0717e))
...
* text shadow in PartLabels ([3a310b1](https://github.com/nrkno/tv-automation-server-core/commit/3a310b1))
* tie snapshot to evaluation ([ec18370](https://github.com/nrkno/tv-automation-server-core/commit/ec18370))
* Timeline always being built without previous part ([a077805](https://github.com/nrkno/tv-automation-server-core/commit/a077805))
...
* top rundown overview labels clipped in wrong places ([5e5c228](https://github.com/nrkno/tv-automation-server-core/commit/5e5c228))
...
* update all data in rundownReplaceMetadata ([8a5a671](https://github.com/nrkno/tv-automation-server-core/commit/8a5a671))
...
* Update names passed to Pieces ([ed0fc0d](https://github.com/nrkno/tv-automation-server-core/commit/ed0fc0d))
...
* update rundown data cache when getting new metadata ([d700783](https://github.com/nrkno/tv-automation-server-core/commit/d700783))
...
* use studioId of parent peripheralDevice ([7dedf9b](https://github.com/nrkno/tv-automation-server-core/commit/7dedf9b))
...
* **playout:** Use original piece id when adding infinite to the timeline, to ensure that any triggers on other objects resolve ([c0382ec](https://github.com/nrkno/tv-automation-server-core/commit/c0382ec))
* **playout:** Use original piece id when adding infinite to the timeline, to ensure that any triggers on other objects resolve ([e7eb871](https://github.com/nrkno/tv-automation-server-core/commit/e7eb871))
...
* **refactor:** existing rundowns were not migrated to the new data structure ([b20bc2d](https://github.com/nrkno/tv-automation-server-core/commit/b20bc2d))
* **refactor:** remove stray debugger calls ([3be5c22](https://github.com/nrkno/tv-automation-server-core/commit/3be5c22))
* **rundown list:** translatify & hide 'Unsynced from MOS' label when no unsynced items ([11b0f29](https://github.com/nrkno/tv-automation-server-core/commit/11b0f29))
* **rundown view:** Always persist original event in user-action methods ([6ba7df8](https://github.com/nrkno/tv-automation-server-core/commit/6ba7df8))
* **runtimeArgs:** Removing infinite items from changed part and anything following ([28ffd5d](https://github.com/nrkno/tv-automation-server-core/commit/28ffd5d))
* **snapshot:** Parts were not being included in the snapshot ([224f806](https://github.com/nrkno/tv-automation-server-core/commit/224f806))
* **snapshot:** Parts were not being included in the snapshot ([d9a427e](https://github.com/nrkno/tv-automation-server-core/commit/d9a427e))
...
* **template:** Caspar portion of in-transition for part rerun whenever timeline was recalculated ([3373457](https://github.com/nrkno/tv-automation-server-core/commit/3373457))
...
* **timeline:** Infinite piece do not update properly on new mos data. Fix detection of the end of the chain, and ensure the last is set to not infinite ([61b2930](https://github.com/nrkno/tv-automation-server-core/commit/61b2930))
* **timeline:** Infinite piece do not update properly on new mos data. Fix detection of the end of the chain, and ensure the last is set to not infinite ([16d9715](https://github.com/nrkno/tv-automation-server-core/commit/16d9715))
* **Timeline:** Corrects the angle of the gradient indication mix-in-transition on a piece ([151ecf9](https://github.com/nrkno/tv-automation-server-core/commit/151ecf9))
* **transition:** Delay piece not contents, to ensure relative triggers against the piece are correct (fixes sluttvignett with transition) ([856da4b](https://github.com/nrkno/tv-automation-server-core/commit/856da4b))
...
* **unsync:** refactor, add method to unsync rundown ([d54c147](https://github.com/nrkno/tv-automation-server-core/commit/d54c147))
...
* Add rundown name to top of run page ([674c392](https://github.com/nrkno/tv-automation-server-core/commit/674c392))
* Add Piece.infiniteMode value for items which are infinite within the Part ([e99c661](https://github.com/nrkno/tv-automation-server-core/commit/e99c661))
...
* add studio.settings, mediaPreviewsUrl and sofieUrl, to replace configs ([adc6cb5](https://github.com/nrkno/tv-automation-server-core/commit/adc6cb5))
...
* Add support panel in Rundown View ([e3cee77](https://github.com/nrkno/tv-automation-server-core/commit/e3cee77))
* Add typeSubVariant field to Part. ([#46](https://github.com/nrkno/tv-automation-server-core/issues/46)) ([82bd4bd](https://github.com/nrkno/tv-automation-server-core/commit/82bd4bd))
* Add typeSubVariant field to Part. ([#46](https://github.com/nrkno/tv-automation-server-core/issues/46)) ([4af88d3](https://github.com/nrkno/tv-automation-server-core/commit/4af88d3))
...
* added .timings object to Part, to track take/playout times during playout ([5d860b3](https://github.com/nrkno/tv-automation-server-core/commit/5d860b3))
...
* added context.rundown, for blueprints to use ([855f6d4](https://github.com/nrkno/tv-automation-server-core/commit/855f6d4))
...
* Added publications for all rundown data, and changed some interfaces ([2365fd2](https://github.com/nrkno/tv-automation-server-core/commit/2365fd2))
* added Part.timings.stoppedPlayback property ([2121245](https://github.com/nrkno/tv-automation-server-core/commit/2121245))
* added Part.timings.takeDone property ([d18d539](https://github.com/nrkno/tv-automation-server-core/commit/d18d539))
...
* added timings property to adlig pieces ([b333bf1](https://github.com/nrkno/tv-automation-server-core/commit/b333bf1))
...
* allow a string array as mediaFlowIds in piece content ([7ac6fb5](https://github.com/nrkno/tv-automation-server-core/commit/7ac6fb5))
* allow reconnection action on click ([3575f4f](https://github.com/nrkno/tv-automation-server-core/commit/3575f4f))
* Allow Studio to define entries in the hotkey legend ([74c1c1c](https://github.com/nrkno/tv-automation-server-core/commit/74c1c1c))
...
* ask before closing an active rundown (if allowed by browser) ([16ee66b](https://github.com/nrkno/tv-automation-server-core/commit/16ee66b))
* Atem SuperSource properties support ([2688142](https://github.com/nrkno/tv-automation-server-core/commit/2688142))
* autonext property is defined on the current Part rather than the next ([09441db](https://github.com/nrkno/tv-automation-server-core/commit/09441db))
...
* blueprints context: handle notes externally (to rundown notes) or internally (to logger) ([63640f2](https://github.com/nrkno/tv-automation-server-core/commit/63640f2))
...
* converted Studio into a class, adding getConfigValue as member method, a step towards DRY ([4af278e](https://github.com/nrkno/tv-automation-server-core/commit/4af278e))
* CoreSystem initial implementation ([06369b2](https://github.com/nrkno/tv-automation-server-core/commit/06369b2))
* countdown to rundown expectedStart ([7b505c5](https://github.com/nrkno/tv-automation-server-core/commit/7b505c5))
...
* disable in next part & refactoring ([669166c](https://github.com/nrkno/tv-automation-server-core/commit/669166c))
...
* ensure each piece has a mosId set ([57c977d](https://github.com/nrkno/tv-automation-server-core/commit/57c977d))
...
* handle mos updates with dynamicallyInserted parts ([1d292c0](https://github.com/nrkno/tv-automation-server-core/commit/1d292c0))
* handle rundownList reply on reload Rundown data, also more refactoring & cleanup ([cee70c5](https://github.com/nrkno/tv-automation-server-core/commit/cee70c5))
...
* implementation of disable-next-piece ([a06d196](https://github.com/nrkno/tv-automation-server-core/commit/a06d196))
...
* include expectedMediaItems in Rundown snapshots ([9fcbba0](https://github.com/nrkno/tv-automation-server-core/commit/9fcbba0))
* Infinite piece ([c02a641](https://github.com/nrkno/tv-automation-server-core/commit/c02a641))
...
* load atem ssrc background when activating rundown ([0eda9b4](https://github.com/nrkno/tv-automation-server-core/commit/0eda9b4))
...
* Move Part duration calculation into templates ([315eb42](https://github.com/nrkno/tv-automation-server-core/commit/315eb42))
...
* prevent next:ing of currently playing part ([b9c9ea1](https://github.com/nrkno/tv-automation-server-core/commit/b9c9ea1))
...
* refactor to use relative durations. affects infinite pieces, autonext, part overlapduration property ([67c5444](https://github.com/nrkno/tv-automation-server-core/commit/67c5444))
...
* reset 'dirty' parts by re-running blueprints on them ([064a84d](https://github.com/nrkno/tv-automation-server-core/commit/064a84d))
...
* rundown full-screen marker ([03010ec](https://github.com/nrkno/tv-automation-server-core/commit/03010ec))
* Rundown unsynced notification ([9effce5](https://github.com/nrkno/tv-automation-server-core/commit/9effce5))
* second upload to atem ([6697a80](https://github.com/nrkno/tv-automation-server-core/commit/6697a80))
* part arguments ([3c5313a](https://github.com/nrkno/tv-automation-server-core/commit/3c5313a))
...
* separate rundown list into synced and unsynced lists ([6b92f40](https://github.com/nrkno/tv-automation-server-core/commit/6b92f40))
...
* Simplify RundownBaseItem type ([2b8257b](https://github.com/nrkno/tv-automation-server-core/commit/2b8257b))
...
* SOURCE_NOT_SET for piece Status ([cff64e1](https://github.com/nrkno/tv-automation-server-core/commit/cff64e1))
...
* Studio key-value config store for template settings ([b37ea17](https://github.com/nrkno/tv-automation-server-core/commit/b37ea17))
* Studio key-value config store for template settings ([812c313](https://github.com/nrkno/tv-automation-server-core/commit/812c313))
...
* **expected media items:** use partId as key ([3803e87](https://github.com/nrkno/tv-automation-server-core/commit/3803e87))
...
* **notification center:** hot-links to rundown note notifications ([f3e9f59](https://github.com/nrkno/tv-automation-server-core/commit/f3e9f59))
* **notification center:** notification count ([b8fbcac](https://github.com/nrkno/tv-automation-server-core/commit/b8fbcac))
* **notification center:** squish segments in rundown view when NC is open ([36b514f](https://github.com/nrkno/tv-automation-server-core/commit/36b514f))
...
* **playout:** Add class to piece first_object to indicate if piece is from the current or previous part ([8de6004](https://github.com/nrkno/tv-automation-server-core/commit/8de6004))
* **playout:** Add class to piece first_object when the piece is a continuation of another ([d53f06b](https://github.com/nrkno/tv-automation-server-core/commit/d53f06b))
* **playout:** Add classes to part-firstobject from the current and prev part. This will allow for some logical triggers which can be influenced by the prev part ([632326f](https://github.com/nrkno/tv-automation-server-core/commit/632326f))
* **playout:** Add object to timeline to indicate whether rundown is active or in rehersal ([d0e850d](https://github.com/nrkno/tv-automation-server-core/commit/d0e850d))
...
* **refactor:** move Runtime Arguments for Blueprints from Studio to ShowStyleBase ([9b2c2d8](https://github.com/nrkno/tv-automation-server-core/commit/9b2c2d8))
* **rundown view:** Introduce a 'duration settling' state to delay the UI update until the actual playout duration is received from playout ([28823c3](https://github.com/nrkno/tv-automation-server-core/commit/28823c3))
...
* **snapshot:** take snapshot of rundown & restore ([fc34f73](https://github.com/nrkno/tv-automation-server-core/commit/fc34f73))
...
* toggle rundown argument on an part with a hotkey ([258c3b3](https://github.com/nrkno/tv-automation-server-core/commit/258c3b3))
* Transition as a seperate Piece, which is not run if the first Part in the show, or the previous Part instructs it to not ([e676a43](https://github.com/nrkno/tv-automation-server-core/commit/e676a43))
* translation improvements ([d3a535d](https://github.com/nrkno/tv-automation-server-core/commit/d3a535d))
* Treat piece marked as virtual solely as markers for the timeline. They are hidden from the ui and are not allowed to place any contents on the timeline ([25e0f42](https://github.com/nrkno/tv-automation-server-core/commit/25e0f42))
...
* **Media-management**
<br> *The Media-management support was started prelimenary in the previous release*
  ...
  <br> allow a string array as mediaFlowIds in piece content ([7ac6fb5](https://github.com/nrkno/tv-automation-server-core/commit/7ac6fb5))
  <br> include expectedMediaItems in Rundown snapshots ([9fcbba0](https://github.com/nrkno/tv-automation-server-core/commit/9fcbba0))
  ...
  <br> *Media manager ui*: fix animations ([10a38de](https://github.com/nrkno/tv-automation-server-core/commit/10a38de))
  <br> *Media manager ui*: nearly finishing the styling ([1bb3116](https://github.com/nrkno/tv-automation-server-core/commit/1bb3116))
  <br> *Media manager ui*: show workflow creation time ([84a4b71](https://github.com/nrkno/tv-automation-server-core/commit/84a4b71))
  <br> *Media manager UI*: WIP ([ccb54f0](https://github.com/nrkno/tv-automation-server-core/commit/ccb54f0))
  <br> *Expected media items*: updateExpectedMediaItems function ([e1ad692](https://github.com/nrkno/tv-automation-server-core/commit/e1ad692))
  <br> *Expected media items*: use partId as key ([3803e87](https://github.com/nrkno/tv-automation-server-core/commit/3803e87))
  <br> settings: add workflow linger time ([9beefda](https://github.com/nrkno/tv-automation-server-core/commit/9beefda))
  <br> *Multi-step success*: introduce keyStep property ([fc8aebd](https://github.com/nrkno/tv-automation-server-core/commit/fc8aebd))
  <br> *OnlySelectedFiles*: support only selected files flag on shared storage options ([dee11d2](https://github.com/nrkno/tv-automation-server-core/commit/dee11d2))
...
* **GUI**
  ...
  <br> Add support panel in Rundown View ([e3cee77](https://github.com/nrkno/tv-automation-server-core/commit/e3cee77))
  ...
  <br> Rundown unsynced notification ([9effce5](https://github.com/nrkno/tv-automation-server-core/commit/9effce5))
  <br> separate rundown list into synced and unsynced lists ([6b92f40](https://github.com/nrkno/tv-automation-server-core/commit/6b92f40))
...
* **Various backend**
  ...
  <br> SOURCE_NOT_SET for piece Status ([cff64e1](https://github.com/nrkno/tv-automation-server-core/commit/cff64e1))
  <br> *Health check*: statusMessage implementation ([9bcf95a](https://github.com/nrkno/tv-automation-server-core/commit/9bcf95a))

* **Other**
  <br> Add LOG_FILE env var to specify the file to log to ([8a192bc](https://github.com/nrkno/tv-automation-server-core/commit/8a192bc))
  ...
  <br> *Hotkeys*: optional cool down ([c9c2743](https://github.com/nrkno/tv-automation-server-core/commit/c9c2743))
  <br> *Playout*: Add classes to part-firstobject from the current and prev part. This will allow for some  ([632326f](https://github.com/nrkno/tv-automation-server-core/commit/632326f))
  <br> *Settings*: playout devices have threadUsage ([b74410c](https://github.com/nrkno/tv-automation-server-core/commit/b74410c))
...
### Bug Fixes
  ...
  <br> allow re-sync of unsynced rundown while it is active ([b824d72](https://github.com/nrkno/tv-automation-server-core/commit/b824d72))
  ...
  <br> bugfix: updateExpectedMediaItems used all pieces in rundown, not just in segmmentLine ([406829b](https://github.com/nrkno/tv-automation-server-core/commit/406829b))
  ...
  <br> Ensure typeVariant on Part is preserved when a rundownList is received ([98b224c](https://github.com/nrkno/tv-automation-server-core/commit/98b224c))
  ...
  <br> issue with source layers marked as used even though they were used in the following part ([71acfb3](https://github.com/nrkno/tv-automation-server-core/commit/71acfb3))
  ...
  <br> make sure that the ad-lib drawer isn't obstructed by the right-hand bar ([8783819](https://github.com/nrkno/tv-automation-server-core/commit/8783819))
  ...
  <br> optimizations during ad-libs (thanks to @baltedewit) ([daa135b](https://github.com/nrkno/tv-automation-server-core/commit/daa135b))
  <br> optimizations during ad-libs (thanks to @baltedewit) ([f50b60e](https://github.com/nrkno/tv-automation-server-core/commit/f50b60e))
  <br> peripheralDevices subscription for rundown data ([90b4e13](https://github.com/nrkno/tv-automation-server-core/commit/90b4e13))
  ...
  <br> remove expectedMediaItems when rundown is removed ([5230695](https://github.com/nrkno/tv-automation-server-core/commit/5230695))
  ...
  <br> resolve issue with ContextMenus in rundown view ([8d9ba96](https://github.com/nrkno/tv-automation-server-core/commit/8d9ba96))
  <br> resolve issue with lowPriority cron jobs ([f7c3c83](https://github.com/nrkno/tv-automation-server-core/commit/f7c3c83))
  <br> rundown notification action ([36cf900](https://github.com/nrkno/tv-automation-server-core/commit/36cf900))
  <br> rundown Notifications fixes attempt no. 3 ([f0eee1f](https://github.com/nrkno/tv-automation-server-core/commit/f0eee1f))
  <br> Rundown Notifications in activeRundown view ([63658b1](https://github.com/nrkno/tv-automation-server-core/commit/63658b1))
  ...
  <br> show connected devices in rundown view ([e804d1e](https://github.com/nrkno/tv-automation-server-core/commit/e804d1e))
  ...
  <br> *Adlib*: Allow for overlap of adlib piece to give preload time ([d2f0dcd](https://github.com/nrkno/tv-automation-server-core/commit/d2f0dcd))
  <br> *Adlib*: An adlib replacing the main piece of a part would not adjust the length of the original. F5/ ([fca6f05](https://github.com/nrkno/tv-automation-server-core/commit/fca6f05))
  <br> *Adlib*: Set as next on part after using F5/F6 would not restore correctly ([3829293](https://github.com/nrkno/tv-automation-server-core/commit/3829293))
  <br> *Clip metadata*: timebase info ([5c39ea8](https://github.com/nrkno/tv-automation-server-core/commit/5c39ea8))
  <br> *Expected media items*: use a function instead of fat arrow ([fa23c05](https://github.com/nrkno/tv-automation-server-core/commit/fa23c05))
  <br> *L3rd pop-up*: filter out properties starting with @ ([19977e7](https://github.com/nrkno/tv-automation-server-core/commit/19977e7))
  <br> *L3rd pop-up*: filter out properties starting with @ ([c85ebeb](https://github.com/nrkno/tv-automation-server-core/commit/c85ebeb))
  <br> *Lookahead*: RETAIN mode now follows the WHEN_CLEAR behaviour instead of PRELOAD ([f0df41c](https://github.com/nrkno/tv-automation-server-core/commit/f0df41c))
  <br> *Media manager ui*: display work step labels correctly ([05cce78](https://github.com/nrkno/tv-automation-server-core/commit/05cce78))
  <br> *Media manager ui*: fix task list layout issue ([9902dc1](https://github.com/nrkno/tv-automation-server-core/commit/9902dc1))
  <br> *Media manager ui*: media manager flow order ([1eb1c48](https://github.com/nrkno/tv-automation-server-core/commit/1eb1c48))
  <br> *Media manager*: label on MM workFlow ([fc2e8d5](https://github.com/nrkno/tv-automation-server-core/commit/fc2e8d5))
  <br> *Migrations*: Broken StudioContext.updateDevice method ([7311d10](https://github.com/nrkno/tv-automation-server-core/commit/7311d10))
  <br> *Migrations*: DependOnResultFrom id was not being prefixed causing it to never work ([602740c](https://github.com/nrkno/tv-automation-server-core/commit/602740c))
  <br> *Notifications*: change unknown to any ([7ac8008](https://github.com/nrkno/tv-automation-server-core/commit/7ac8008))
  <br> *Playout*: bad timing during autonext ([5524e3b](https://github.com/nrkno/tv-automation-server-core/commit/5524e3b))
  <br> *Playout*: Ensure that infinite pieces are reset correctly after being removed by some  ([045c9b1](https://github.com/nrkno/tv-automation-server-core/commit/045c9b1))
  <br> *Playout*: Ensure that infinite pieces are reset correctly after being removed by some  ([e4f8a83](https://github.com/nrkno/tv-automation-server-core/commit/e4f8a83))
  <br> *Playout*: Fix overlap tests ([15628a2](https://github.com/nrkno/tv-automation-server-core/commit/15628a2))
  <br> *Playout*: ID prefixing did not handle logical object id references ([44f2883](https://github.com/nrkno/tv-automation-server-core/commit/44f2883))
  <br> *Playout*: Infinite item continuations were not always updated correctly ([7a7aed6](https://github.com/nrkno/tv-automation-server-core/commit/7a7aed6))
  <br> *Playout*: Objects being written out without an id ([b05a851](https://github.com/nrkno/tv-automation-server-core/commit/b05a851))
  <br> *Playout*: Optimise layers of promises in infinite generation logic, and reorder function paramet ([e400c7c](https://github.com/nrkno/tv-automation-server-core/commit/e400c7c))
  <br> *Playout*: Typo in ID prefixing ([249b35d](https://github.com/nrkno/tv-automation-server-core/commit/249b35d))
  <br> *Playout*: Use original piece id when adding infinite to the timeline, to ensure that any triggers  ([c0382ec](https://github.com/nrkno/tv-automation-server-core/commit/c0382ec))
  <br> *Playout*: Use original piece id when adding infinite to the timeline, to ensure that any triggers  ([e7eb871](https://github.com/nrkno/tv-automation-server-core/commit/e7eb871))
  <br> *Rundown list*: translatify & hide 'Unsynced from MOS' label when no unsynced items ([11b0f29](https://github.com/nrkno/tv-automation-server-core/commit/11b0f29))
  <br> *Rundown list*: translatify & hide 'Unsynced from MOS' label when no unsynced items ([fa56ecd](https://github.com/nrkno/tv-automation-server-core/commit/fa56ecd))
...
### Other / Chores
  ...
  <br> *Blueprint*: Move interface fields from blueprint-integration ([d77d4fc](https://github.com/nrkno/tv-automation-server-core/commit/d77d4fc))
  <br> *Media manager UI*: drop unnecessary checks after getPeripheralDevice ([33fde80](https://github.com/nrkno/tv-automation-server-core/commit/33fde80))
  <br> *Release*: 0.21.0-0 ([3fd5334](https://github.com/nrkno/tv-automation-server-core/commit/3fd5334))
  <br> *Release*: cherry-pick package version from release 6 ([c1b0961](https://github.com/nrkno/tv-automation-server-core/commit/c1b0961))
  <br> *Release*: copy version from master ([a6884d9](https://github.com/nrkno/tv-automation-server-core/commit/a6884d9))
...
* **Media-management**
<br> *The Media Management in this release is preliminary, and is a preparation for the [Media-manager Gateway](https://github.com/nrkno/tv-automation-media-management)*, full support is planned for the next release.<br>
  <br> Configuration UI for media manager ([b1883ec](https://github.com/nrkno/tv-automation-server-core/commit/b1883ec))
  <br> Add expected media items collection ([931536e](https://github.com/nrkno/tv-automation-server-core/commit/931536e))
  <br> Allow a string array as mediaFlowIds in piece content ([7ac6fb5](https://github.com/nrkno/tv-automation-server-core/commit/7ac6fb5))
  <br> Include expectedMediaItems in Rundown snapshots ([9fcbba0](https://github.com/nrkno/tv-automation-server-core/commit/9fcbba0))
  ...
  <br> Use partId as key ([3803e87](https://github.com/nrkno/tv-automation-server-core/commit/3803e87))
  <br> Media manager settings: add 'mediaPath' property to storages ([50185b2](https://github.com/nrkno/tv-automation-server-core/commit/50185b2))
...
* **GUI**
  ...
  <br> Add classes to part-firstobject from the current and prev part. This will allow for some  ([632326f](https://github.com/nrkno/tv-automation-server-core/commit/632326f))
...
### Bug Fixes
* **adlib**: An adlib replacing the main piece of a part would not adjust the length of the original. F5/ ([fca6f05](https://github.com/nrkno/tv-automation-server-core/commit/fca6f05))
* **expected media items**: use a function instead of fat arrow ([fa23c05](https://github.com/nrkno/tv-automation-server-core/commit/fa23c05))
* **lookahead**: RETAIN mode now follows the WHEN_CLEAR behaviour instead of PRELOAD ([f0df41c](https://github.com/nrkno/tv-automation-server-core/commit/f0df41c))
* **migrations**: Broken StudioContext.updateDevice method ([7311d10](https://github.com/nrkno/tv-automation-server-core/commit/7311d10))
* **migrations**: DependOnResultFrom id was not being prefixed causing it to never work ([602740c](https://github.com/nrkno/tv-automation-server-core/commit/602740c))
...
* some work on notification center ([58ad599](https://github.com/nrkno/tv-automation-server-core/commit/58ad599))
* some work on notification center ([8e2c269](https://github.com/nrkno/tv-automation-server-core/commit/8e2c269))
* hot-links to rundown note notifications ([f3e9f59](https://github.com/nrkno/tv-automation-server-core/commit/f3e9f59))
* notification count ([b8fbcac](https://github.com/nrkno/tv-automation-server-core/commit/b8fbcac))
* squish segments in rundown view when NC is open ([36b514f](https://github.com/nrkno/tv-automation-server-core/commit/36b514f))
...
* do not display notification count if = 0 ([1fe9a39](https://github.com/nrkno/tv-automation-server-core/commit/1fe9a39))
* fix notification center toggle button in rundown view ([894c1e2](https://github.com/nrkno/tv-automation-server-core/commit/894c1e2))
* fix rundown overview to line up with the Segments column ([0906cab](https://github.com/nrkno/tv-automation-server-core/commit/0906cab))
* notification count position ([1d8d2cb](https://github.com/nrkno/tv-automation-server-core/commit/1d8d2cb))
* reintroduce RundownNotifier into RundownView ([e70e5c9](https://github.com/nrkno/tv-automation-server-core/commit/e70e5c9))
...
* hold: Disable transition when leaving HOLD ([809dd34](https://github.com/nrkno/tv-automation-server-core/commit/809dd34))
* hold: Disable transition when leaving or leaving HOLD ([ef5cbcb](https://github.com/nrkno/tv-automation-server-core/commit/ef5cbcb))
* hold: Ensure the original stk does not get picked up as a dynamic object when setting the part as ([225304d](https://github.com/nrkno/tv-automation-server-core/commit/225304d))
* hold: When extending a piece during hold, use the original id to make any triggers on the piece wor ([669a4b2](https://github.com/nrkno/tv-automation-server-core/commit/669a4b2))
* migrations: Check migrate function exists before trying to run it ([cf076f5](https://github.com/nrkno/tv-automation-server-core/commit/cf076f5))
...
* Remove old mock rundown data ([5d1b8ff](https://github.com/nrkno/tv-automation-server-core/commit/5d1b8ff))
...
* **Rundown arguments**
  <br> Merge pull request #55 from nrkno/feature/rundown-arguments ([6d8653c](https://github.com/nrkno/tv-automation-server-core/commit/6d8653c)), closes [#55](https://github.com/nrkno/tv-automation-server-core/issues/55)
...
* **Snapshots**
  <br> Merge branch 'feature/rundown-snapshot' into develop ([6bed457](https://github.com/nrkno/tv-automation-server-core/commit/6bed457))
  ...
  <br> take snapshot of rundown & restore ([fc34f73](https://github.com/nrkno/tv-automation-server-core/commit/fc34f73))
  <br> wip: rundown snaphots ([eb069da](https://github.com/nrkno/tv-automation-server-core/commit/eb069da))
...
* **Refactoring og mos data flow**
  ...
  <br> handle rundownList reply on reload Rundown data, also more refactoring & cleanup ([cee70c5](https://github.com/nrkno/tv-automation-server-core/commit/cee70c5))
...
* **Added support for Panasonic PTZ cameras**
  ...
  <br> chore: Create a mock rundown with PTZ items ([986c3f7](https://github.com/nrkno/tv-automation-server-core/commit/986c3f7))
...
* **Core optimizations: lowering latencies during playout**
  ...
  <br> fix: BIG optimization in rundownTake and affected functions, made database fetches async & parallel where ([aa6f4bd](https://github.com/nrkno/tv-automation-server-core/commit/aa6f4bd))
  ...
  <br> Fix: fix issues with Part indexes ([0f5b30e](https://github.com/nrkno/tv-automation-server-core/commit/0f5b30e))
...
* **Added various internal timing logging**
  ...
  <br> feat: added Part.timings.stoppedPlayback property ([2121245](https://github.com/nrkno/tv-automation-server-core/commit/2121245))
  <br> feat: added Part.timings.takeDone property ([d18d539](https://github.com/nrkno/tv-automation-server-core/commit/d18d539))
...
#### Other
* feat: added context.rundown, for blueprints to use ([855f6d4](https://github.com/nrkno/tv-automation-server-core/commit/855f6d4))
...
* **Button for making window fullscreen**
  ...
  <br> feat: rundown full-screen marker ([03010ec](https://github.com/nrkno/tv-automation-server-core/commit/03010ec))
...
* feat: Allow Studio to define entries in the hotkey legend ([74c1c1c](https://github.com/nrkno/tv-automation-server-core/commit/74c1c1c))
...
* feat: Treat piece marked as virtual solely as markers for the timeline. They are hidden from the ui an ([25e0f42](https://github.com/nrkno/tv-automation-server-core/commit/25e0f42))
...
* fix: resetting rundown rewind ([a122f2c](https://github.com/nrkno/tv-automation-server-core/commit/a122f2c))
* fix: retry strategy for restart casparcg cronjob ([b54f0f6](https://github.com/nrkno/tv-automation-server-core/commit/b54f0f6))
* fix: rundown overview crashed during rebuild of rundown ([d2c62a1](https://github.com/nrkno/tv-automation-server-core/commit/d2c62a1))
...
* fix: Timeline always being built without previous part ([a077805](https://github.com/nrkno/tv-automation-server-core/commit/a077805))
...
* fix: top rundown overview labels clipped in wrong places ([5e5c228](https://github.com/nrkno/tv-automation-server-core/commit/5e5c228))
...
* fix: reset disabled flag on part and rundown reset ([8f69f67](https://github.com/nrkno/tv-automation-server-core/commit/8f69f67))
* fix(hold): Too many piece being extended for hold mode ([f644e32](https://github.com/nrkno/tv-automation-server-core/commit/f644e32))
...
* fix(rundown view): Always persist original event in user-action methods ([6ba7df8](https://github.com/nrkno/tv-automation-server-core/commit/6ba7df8))
### Other
...
* **Add typeSubVariant field to Part. (#46) ([4af88d3](https://github.com/nrkno/tv-automation-server-core/commit/4af88d3)), closes [#46]**
  <br> Add typeSubVariant field to Part. (#46) ([82bd4bd](https://github.com/nrkno/tv-automation-server-core/commit/82bd4bd)), closes [#46]
...
* **Handle received Rundown data when having added (adlibbed) parts**
  <br> handle mos updates with dynamicallyInserted parts ([1d292c0](https://github.com/nrkno/tv-automation-server-core/commit/1d292c0))
* Move Part duration calculation into blueprints ([315eb42](https://github.com/nrkno/tv-automation-server-core/commit/315eb42))
...
* **Major rework of how Rundown Activation, Deactication, Reset, Reload etc, are done. Adding GUI prompts if user tries to do an action he/she might/should not.**
...
* **"Queueability", ie be able to add Adlibs as "next part" rather than insert into current part.**
...
* **Check status of Piece content (for things like "Source missing" or "Source Broken")**
  <br> mediaObjects.checkPieceContentStatus ([66d4427](https://github.com/nrkno/tv-automation-server-core/commit/66d4427))
...
#### GUI
* Shortcuts: standarize shortcut label display, support numpad ([4c5ba74](https://github.com/nrkno/tv-automation-server-core/commit/4c5ba74))
* rundown view: Retain the special segment color even when On Air/Next ([2596a8e](https://github.com/nrkno/tv-automation-server-core/commit/2596a8e))
...
* new style of part markers (WIP) ([a3569ce](https://github.com/nrkno/tv-automation-server-core/commit/a3569ce))
...
* Display OK status in rundown View with nowrap ([0763c3a](https://github.com/nrkno/tv-automation-server-core/commit/0763c3a))
* rewindsegments on resetRundown ([57c1c53](https://github.com/nrkno/tv-automation-server-core/commit/57c1c53))
* smarter reloadRundown ([33c11ba](https://github.com/nrkno/tv-automation-server-core/commit/33c11ba))
* styling fix in ShowStyleSettings ([681163a](https://github.com/nrkno/tv-automation-server-core/commit/681163a))
* transition: Delay piece not contents, to ensure relative triggers against the piece are correct (fi ([856da4b](https://github.com/nrkno/tv-automation-server-core/commit/856da4b))(https://github.com/nrkno/tv-automation-server-core/issues/46)(https://github.com/nrkno/tv-automation-server-core/issues/46)
...
* Timeline-display: Infinite piece do not update properly on new mos data. Fix detection of the end of the  ([16d9715](https://github.com/nrkno/tv-automation-server-core/commit/16d9715))
* rundown overview:fix label lengths ([41dea0b](https://github.com/nrkno/tv-automation-server-core/commit/41dea0b))
...
* fix: issue with rundownPrepareForBroadcast ([c3ad30c](https://github.com/nrkno/tv-automation-server-core/commit/c3ad30c))
* fix: Add default exclusivity groups to InitDB ([dfd1782](https://github.com/nrkno/tv-automation-server-core/commit/dfd1782))
* fix: hot fix for rehearsal activation when an rundown is already active ([648c02d](https://github.com/nrkno/tv-automation-server-core/commit/648c02d))
* fix: disable client-side rundown updates ([72ba831](https://github.com/nrkno/tv-automation-server-core/commit/72ba831))
* fix: broken GUI Pieces resolution, when simulating timeline output ([60fb843](https://github.com/nrkno/tv-automation-server-core/commit/60fb843))
...
* fix: resetRundown should update timeline ([0d01e6a](https://github.com/nrkno/tv-automation-server-core/commit/0d01e6a))
...
* fix: be able to reset & activate inactivated rundown ([e7d52da](https://github.com/nrkno/tv-automation-server-core/commit/e7d52da))
...
* fix(lookahead): Dont run lookahead on abs0 piece if there is an active transition. ([191df09](https://github.com/nrkno/tv-automation-server-core/commit/191df09))
