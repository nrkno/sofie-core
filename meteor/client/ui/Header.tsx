...
class Header extends MeteorReactComponent<
	Translated<IPropsHeader & ITrackedPropsHeader>,
	IStateHeader
> {
			...
			<React.Fragment>
				...
				<ErrorBoundary>
					<div className="status-bar">
						...
						/>
						<SupportPopUpToggle
							onClick={this.onToggleSupportPanel}
							isOpen={this.state.showSupportPanel}
						/>
					</div>
				</ErrorBoundary>
...
export default translateWithTracker(
	(props: IPropsHeader & InjectedTranslateProps) => {
