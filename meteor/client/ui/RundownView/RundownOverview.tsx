	...
	return (
		<ErrorBoundary>
			<div
				...
				{props.isNext && (
					<div className="rundown__overview__segment__part__next-line"></div>
				)}
				{props.isLive && (
					<div
...
const SegmentOverview: React.SFC<ISegmentPropsHeader> = (
	props: ISegmentPropsHeader
) => {
		...
		(props.segment.items && (
			<div
				className={ClassNames('rundown__overview__segment', {
					next: props.segment.items.find(
						(i) => i._id === props.rundown.nextPartId
					)
						? true
						: false,
					live: props.segment.items.find(
						(i) => i._id === props.rundown.currentPartId
					)
						? true
						: false
				})}
...
export const RundownOverview = withTiming<
	RundownOverviewProps,
	RundownOverviewState
>()(
	withTracker<
		WithTiming<RundownOverviewProps>,
		RundownOverviewState,
