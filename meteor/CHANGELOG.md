...
* feat: add checkbox for debugLogging in media manager ([64b80e9](https://github.com/nrkno/tv-automation-server-core/commit/64b80e9))
* feat: add httpWatcher settings ([fbb91d9](https://github.com/nrkno/tv-automation-server-core/commit/fbb91d9))
* feat: add option to input data into a ModalDialogue ([ef54b74](https://github.com/nrkno/tv-automation-server-core/commit/ef54b74))
* feat: Add warning to rundown when config changed (#69) ([4f5e6a9](https://github.com/nrkno/tv-automation-server-core/commit/4f5e6a9)), closes [#69](https://github.com/nrkno/tv-automation-server-core/issues/69)
* feat: change labeled buttons to icons with tooltips in Media Transfer Status ([c5e582b](https://github.com/nrkno/tv-automation-server-core/commit/c5e582b))
* feat: implement timeline-visualizer view ([e725618](https://github.com/nrkno/tv-automation-server-core/commit/e725618))
* feat: log WorkFlow success or failure ([8e7d9d7](https://github.com/nrkno/tv-automation-server-core/commit/8e7d9d7))
* feat: move new timeline visualizer to replace the old broken one ([174dd7e](https://github.com/nrkno/tv-automation-server-core/commit/174dd7e))
* feat: set in/out points through itemReplace ([4d31d70](https://github.com/nrkno/tv-automation-server-core/commit/4d31d70))
* feat: SH-121-Double-clicking zoom-scrubber should mean "zoom to show everything in this segment" ([aeadc46](https://github.com/nrkno/tv-automation-server-core/commit/aeadc46))
* feat: show user activity log for timeslot of recording ([5c75305](https://github.com/nrkno/tv-automation-server-core/commit/5c75305))
* feat: speech synthesis ([eb9643a](https://github.com/nrkno/tv-automation-server-core/commit/eb9643a))
* feat: stub of setting in & out points ([0852b42](https://github.com/nrkno/tv-automation-server-core/commit/0852b42))
* feat: support displayDurationGroups in RO view ([460df8d](https://github.com/nrkno/tv-automation-server-core/commit/460df8d))
* feat: timeline-visualizer: add details-on-click ([c81243c](https://github.com/nrkno/tv-automation-server-core/commit/c81243c))
...
* fix: add shortcut ctrl+shift+enter-on-numpad to reload ([b9820ff](https://github.com/nrkno/tv-automation-server-core/commit/b9820ff))
* fix: Allow translations of media warnings, show clip as broken until scan finished ([b693de7](https://github.com/nrkno/tv-automation-server-core/commit/b693de7))
* fix: apply some fixes when restoring a RO ([b04bf53](https://github.com/nrkno/tv-automation-server-core/commit/b04bf53))
* fix: change logging to info on device state change ([1cc9429](https://github.com/nrkno/tv-automation-server-core/commit/1cc9429))
* fix: Changed the color of the top bar during Rehearsal mode to something a little less hideous. ([1e887e3](https://github.com/nrkno/tv-automation-server-core/commit/1e887e3))
* fix: do not refresh RO notifications if RO/showStyleBase/studioInstallation changes ([5702939](https://github.com/nrkno/tv-automation-server-core/commit/5702939))
* fix: externalMessage: update status on removed document ([75a1053](https://github.com/nrkno/tv-automation-server-core/commit/75a1053))
* fix: getHash undefined exception in asRunLog ([8faab78](https://github.com/nrkno/tv-automation-server-core/commit/8faab78))
* fix: make sure that the OnAir line connects to the label ([3788672](https://github.com/nrkno/tv-automation-server-core/commit/3788672))
* fix: more optimizations ([df8c397](https://github.com/nrkno/tv-automation-server-core/commit/df8c397))
* fix: optimizations in roTake ([3457e73](https://github.com/nrkno/tv-automation-server-core/commit/3457e73))
* fix: output version differ error ([8816ed3](https://github.com/nrkno/tv-automation-server-core/commit/8816ed3))
* fix: refactor ([9e9d60a](https://github.com/nrkno/tv-automation-server-core/commit/9e9d60a))
* fix: remove memoization of RVars ([ca22155](https://github.com/nrkno/tv-automation-server-core/commit/ca22155))
* fix: resolve issue with segmentLineDisplayDuration & segment duration ([a73ed09](https://github.com/nrkno/tv-automation-server-core/commit/a73ed09))
* fix: RO config changed notification not updating when RO is updated ([f5c2540](https://github.com/nrkno/tv-automation-server-core/commit/f5c2540))
* fix: Running order status notifying wrong dep ([e6b84e5](https://github.com/nrkno/tv-automation-server-core/commit/e6b84e5))
* fix: seek support in VT, STK, hoverscrub ([43e413b](https://github.com/nrkno/tv-automation-server-core/commit/43e413b))
* fix: settings styling improvements, code fixes ([d9484cd](https://github.com/nrkno/tv-automation-server-core/commit/d9484cd))
* fix: ShowStyleVariant settings not saving changes ([e90137b](https://github.com/nrkno/tv-automation-server-core/commit/e90137b))
* fix: skip untranslated strings from po files, update i18next-conv to latest version ([1de4ccb](https://github.com/nrkno/tv-automation-server-core/commit/1de4ccb))
* fix: Toggle hotkeys legend in support panel ([e6f4769](https://github.com/nrkno/tv-automation-server-core/commit/e6f4769))
* fix: typo ([2efc829](https://github.com/nrkno/tv-automation-server-core/commit/2efc829))
* fix: update package versions to fix audit issues ([be3cae5](https://github.com/nrkno/tv-automation-server-core/commit/be3cae5))
* fix: Update RO change notification on an interval, to ensure it catches changes to other document ty ([79d8c05](https://github.com/nrkno/tv-automation-server-core/commit/79d8c05))
* fix: use a single setState in updateVersions in MigrationsView ([afd730a](https://github.com/nrkno/tv-automation-server-core/commit/afd730a))
* fix: use floor for all positioning and sizing of segment lines ([8a84a7e](https://github.com/nrkno/tv-automation-server-core/commit/8a84a7e))
* fix: when restoring a runningOrder, use the .active property of the database (or false) ([b5e5b05](https://github.com/nrkno/tv-automation-server-core/commit/b5e5b05))
* fix: wrap all MeteorReactComponent.autoruns in nonreactive. ([9020c96](https://github.com/nrkno/tv-automation-server-core/commit/9020c96))
* fix(backup): make restore running order less strict ([e78313f](https://github.com/nrkno/tv-automation-server-core/commit/e78313f))
* fix(countdowns): split text parsing ([9a174ae](https://github.com/nrkno/tv-automation-server-core/commit/9a174ae))
* fix(infinite): Persist overrideDuration when updating infinites ([b15bfa3](https://github.com/nrkno/tv-automation-server-core/commit/b15bfa3))
* fix(Notifications refresh): limit amount of reactive vars ([2c01e66](https://github.com/nrkno/tv-automation-server-core/commit/2c01e66))
* fix(playout): StatObj not being generated ([581d99d](https://github.com/nrkno/tv-automation-server-core/commit/581d99d))
* fix(presenter screen): split background + text spacing ([9aad750](https://github.com/nrkno/tv-automation-server-core/commit/9aad750))
