...
describe('Test blueprint post-process', () => {
	...
	describe('postProcessAdLibPieces', () => {
		...
		testInFiber('various pieces', () => {
			...
			expect(context.getHashId).toHaveBeenNthCalledWith(
				1,
				'blueprint9_undefined_adlib_piece_0'
			);
			expect(context.getHashId).toHaveBeenNthCalledWith(
				2,
				'blueprint9_undefined_adlib_piece_1'
			);
			expect(context.getHashId).toHaveBeenNthCalledWith(
				3,
				'blueprint9_undefined_adlib_piece_2'
			);
			expect(context.getHashId).toHaveBeenNthCalledWith(
				4,
				'blueprint9_undefined_adlib_piece_3'
			);
	...
	describe('postProcessPieces', () => {
		...
		testInFiber('various pieces', () => {
			...
			expect(context.getHashId).toHaveBeenNthCalledWith(
				1,
				'blueprint9_part8_piece_0'
			);
			expect(context.getHashId).toHaveBeenNthCalledWith(
				2,
				'blueprint9_part8_piece_1'
			);
