				...
				<div className="mod mvl mhs">
					...
					<div className="flex-row">
						...
						<div className="flex-col c12 rm-c11 status-dialog">
							<Switch>
								<Route
									path="/testTools/timeline/:studioId"
									component={TimelineView}
								/>
								<Route
									path="/testTools/timeline"
									component={TimelineStudioSelect}
								/>
								<Route
									path="/testTools/recordings/:studioId/:recordingId"
									component={RecordingView}
								/>
								<Route
									path="/testTools/recordings/:studioId"
									component={RecordingsList}
								/>
								<Route
									path="/testTools/recordings"
									component={RecordingsStudioSelect}
								/>
								<Route
									path="/testTools/userlogplayer/:rundownId"
									component={UserLogPlayerPage}
								/>
								<Route
									path="/testTools/userlogplayer"
									component={UserLogRundownSelect}
								/>
