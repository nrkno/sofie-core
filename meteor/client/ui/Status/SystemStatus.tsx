...
import { StatusResponse, SystemStatusAPI } from '../../../lib/api/systemStatus';
...
export const DeviceItem = i18next.translate()(
	class extends React.Component<Translated<IDeviceItemProps>, IDeviceItemState> {
						...
						if (err) {
							...
							NotificationCenter.push(
								new Notification(
									undefined,
									NoticeLevel.NOTIFICATION,
									t('Formatting HyperDeck disks on device "{{deviceName}}"...', {
										deviceName: device.name
									}),
									'SystemStatus'
								)
				...
				<div key={this.props.device._id} className="device-item">
					...
					<div className="device-item__id">
						<Tooltip
							...
							{getAllowConfigure() ? (
								<div className="value">
									<Link to={'/settings/peripheralDevice/' + this.props.device._id}>
