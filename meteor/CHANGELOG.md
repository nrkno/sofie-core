...
* bugfix: updateExpectedMediaItems used all segmentLineItems in rundown, not just in segmmentLine ([406829b](https://github.com/nrkno/tv-automation-server-core/commit/406829b))
...
### Bug Fixes
  ...
  <br> bugfix: updateExpectedMediaItems used all segmentLineItems in rundown, not just in segmmentLine ([406829b](https://github.com/nrkno/tv-automation-server-core/commit/406829b))
  ...
  <br> *Adlib*: Allow for overlap of adlib sli to give preload time ([d2f0dcd](https://github.com/nrkno/tv-automation-server-core/commit/d2f0dcd))
  <br> *Adlib*: An adlib replacing the main sli of a sl would not adjust the length of the original. F5/ ([fca6f05](https://github.com/nrkno/tv-automation-server-core/commit/fca6f05))
  ...
  <br> *Playout*: Ensure that infinite segmentLineItems are reset correctly after being removed by some  ([045c9b1](https://github.com/nrkno/tv-automation-server-core/commit/045c9b1))
  <br> *Playout*: Ensure that infinite segmentLineItems are reset correctly after being removed by some  ([e4f8a83](https://github.com/nrkno/tv-automation-server-core/commit/e4f8a83))
  ...
  <br> *Playout*: Use original sli id when adding infinite to the timeline, to ensure that any triggers  ([c0382ec](https://github.com/nrkno/tv-automation-server-core/commit/c0382ec))
  <br> *Playout*: Use original sli id when adding infinite to the timeline, to ensure that any triggers  ([e7eb871](https://github.com/nrkno/tv-automation-server-core/commit/e7eb871))
