...
export const MosDeviceSettingsComponent = translate()(
	class MosDeviceSettingsComponent extends React.Component<
						...
						return (
							<React.Fragment key={deviceId0}>
								<tr
									...
									<th className="settings-studio-device__name c1">{deviceId}</th>
									<td className="settings-studio-device__primary_id c3">{(device.primary || { id: '' }).id}</td>
									<td className="settings-studio-device__primary_host c2">{(device.primary || { host: '' }).host}</td>
									<td className="settings-studio-device__secondary_id c3">{(device.secondary || { id: '' }).id}</td>
											...
											<div>
												...
												<div className="mod mvs mhs">
													<label className="field">
														...
														<EditAttribute
															modifiedClassName="bghl"
															attribute={'settings.devices.' + deviceId + '.primary.dontUseQueryPort'}
															obj={this.props.device}
															type="checkbox"
															collection={PeripheralDevices}
															className="input text-input input-l"></EditAttribute>
												...
												<div className="mod mvs mhs">
													<label className="field">
														...
														<EditAttribute
															modifiedClassName="bghl"
															attribute={'settings.devices.' + deviceId + '.secondary.dontUseQueryPort'}
															obj={this.props.device}
															type="checkbox"
															collection={PeripheralDevices}
															className="input text-input input-l"></EditAttribute>
