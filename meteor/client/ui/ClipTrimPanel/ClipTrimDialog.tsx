...
export const ClipTrimDialog = translate()(
	class ClipTrimDialog extends React.Component<IProps & InjectedTranslateProps, IState> {
		constructor(props: IProps & InjectedTranslateProps) {
			...
			this.state = {
				inPoint: ((this.props.selectedPiece.content as VTContent).editable as VTEditableParameters)
					.editorialStart,
				duration: ((this.props.selectedPiece.content as VTContent).editable as VTEditableParameters)
					.editorialDuration
			};
		}
