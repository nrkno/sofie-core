...
let methods: Methods = {};
methods[PlayoutAPI.methods.rundownPrepareForBroadcast] = (
	rundownId: string
) => {
...
methods[PlayoutAPI.methods.rundownResetAndActivate] = (
	rundownId: string,
	rehearsal?: boolean
) => {
	return ServerPlayoutAPI.resetAndActivateRundown(rundownId, rehearsal);
};
methods[PlayoutAPI.methods.rundownActivate] = (
	rundownId: string,
	rehearsal: boolean
) => {
...
methods[PlayoutAPI.methods.pieceTakeNow] = (
	rundownId: string,
	partId: string,
	pieceId: string
) => {
...
methods[PlayoutAPI.methods.rundownTogglePartArgument] = (
	rundownId: string,
	partId: string,
	property: string,
	value: string
) => {
	return ServerPlayoutAPI.rundownTogglePartArgument(
		rundownId,
		partId,
		property,
		value
...
methods[PlayoutAPI.methods.rundownSetNext] = (
	rundownId: string,
	partId: string,
...
methods[PlayoutAPI.methods.rundownMoveNext] = (
	rundownId: string,
	horisontalDelta: number,
	verticalDelta: number
) => {
	return ServerPlayoutAPI.moveNextPart(
		rundownId,
		horisontalDelta,
		verticalDelta,
		true
...
methods[PlayoutAPI.methods.rundownDisableNextPiece] = (
	rundownId: string,
	undo?: boolean
) => {
...
// }
methods[PlayoutAPI.methods.segmentAdLibPieceStart] = (
	rundownId: string,
	partId: string,
	pieceId: string,
	queue: boolean
) => {
	return ServerPlayoutAPI.segmentAdLibPieceStart(
		rundownId,
		partId,
		pieceId,
		queue
...
methods[PlayoutAPI.methods.rundownBaselineAdLibPieceStart] = (
	rundownId: string,
	partId: string,
	pieceId: string,
	queue: boolean
) => {
	return ServerPlayoutAPI.rundownBaselineAdLibPieceStart(
		rundownId,
		partId,
		pieceId,
		queue
...
methods[PlayoutAPI.methods.segmentAdLibPieceStop] = (
	rundownId: string,
	partId: string,
	pieceId: string
) => {
...
methods[PlayoutAPI.methods.sourceLayerOnPartStop] = (
	rundownId: string,
	partId: string,
	sourceLayerId: string
) => {
	return ServerPlayoutAPI.sourceLayerOnPartStop(
		rundownId,
		partId,
		sourceLayerId
	);
...
// }
methods[PlayoutAPI.methods.sourceLayerStickyPieceStart] = (
	rundownId: string,
	sourceLayerId: string
) => {
