...
export async function studio_getShowStyleId(
	...
	const context = new StudioUserContext('getShowStyleId', socket, invocationId, msg)
...
export async function studio_getRundownPlaylistInfo(
	...
	const context = new StudioUserContext('getRundownPlaylistInfo', socket, invocationId, msg)
