		...
		return (<div>
			<div className='mod mvs mhn'>
				<label className='field'>
					...
					<div className='mdi'>
						<div>
							{t(device.configManifest.deviceOAuthFlow!.credentialsHelp)}
						</div>
						<div>
							<a href={device.configManifest.deviceOAuthFlow!.credentialsURL} target='_blank' >{device.configManifest.deviceOAuthFlow!.credentialsURL}</a>
						</div>
