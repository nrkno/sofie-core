...
import { ConfigManifestEntry, ConfigManifestEntryType, ConfigManifestEnumEntry } from '../../../../lib/api/deviceConfig'
...
export const ConfigManifestEntryComponent = withTranslation()(class ConfigManifestEntryComponent extends React.Component<Translated<IConfigManifestEntryComponentProps>, {}> {
	...
	renderEditAttribute (configField: ConfigManifestEntry, obj?: any, prefix?: string) {
		...
		if (configField.type === ConfigManifestEntryType.FLOAT || configField.type === ConfigManifestEntryType.INT) {
			...
			return <EditAttribute modifiedClassName='bghl' attribute={attribute} obj={obj} type='checkbox' collection={PeripheralDevices} className=''></EditAttribute>
