...
Meteor.methods({
	...
	'debug_roMock0_rmove' () {
		let pd = getPD()
		ServerPeripheralDeviceAPI.mosRoDelete(pd._id, pd.token, new MosString128('MAENPSTEST14;P_SERVER14\\W;07C8C71B-1835-493D-94E1678FD1425B71'))
	},
	'debug_roMock0' () {
		let pd = getPD()
		let id = pd._id
