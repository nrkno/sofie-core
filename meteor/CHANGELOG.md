...
* bugfix: didn't correctly find the right piece in next segmentLine ([0f9313f](https://github.com/nrkno/tv-automation-server-core/commit/0f9313f))
...
* Ensure typeVariant on SegmentLine is preserved when a rundownList is received ([98b224c](https://github.com/nrkno/tv-automation-server-core/commit/98b224c))
...
* **adlib:** An adlib replacing the main piece of a sl would not adjust the length of the original. F5/F6 sometimes failed to insert a piece correctly, causing black ([fca6f05](https://github.com/nrkno/tv-automation-server-core/commit/fca6f05))
...
* Add Piece.infiniteMode value for items which are infinite within the SegmentLine ([e99c661](https://github.com/nrkno/tv-automation-server-core/commit/e99c661))
...
* refactor to use relative durations. affects infinite pieces, autonext, segmentline overlapduration property ([67c5444](https://github.com/nrkno/tv-automation-server-core/commit/67c5444))
...
* **playout:** Add class to piece first_object to indicate if piece is from the current or previous sl ([8de6004](https://github.com/nrkno/tv-automation-server-core/commit/8de6004))
...
* toggle rundown argument on an SL with a hotkey ([258c3b3](https://github.com/nrkno/tv-automation-server-core/commit/258c3b3))
* Transition as a seperate Piece, which is not run if the first SegmentLine in the show, or the previous SegmentLine instructs it to not ([e676a43](https://github.com/nrkno/tv-automation-server-core/commit/e676a43))
...
<br> *The Media-management support was started prelimenary in the previous release*
  ...
  <br> *Expected media items*: use segmentLineId as key ([3803e87](https://github.com/nrkno/tv-automation-server-core/commit/3803e87))
...
* **Other**
  ...
  <br> *Playout*: Add classes to sl-firstobject from the current and prev sl. This will allow for some  ([632326f](https://github.com/nrkno/tv-automation-server-core/commit/632326f))
...
### Bug Fixes
  ...
  <br> Ensure typeVariant on SegmentLine is preserved when a rundownList is received ([98b224c](https://github.com/nrkno/tv-automation-server-core/commit/98b224c))
  ...
  <br> *Adlib*: An adlib replacing the main piece of a sl would not adjust the length of the original. F5/ ([fca6f05](https://github.com/nrkno/tv-automation-server-core/commit/fca6f05))
  <br> *Adlib*: Set as next on SL after using F5/F6 would not restore correctly ([3829293](https://github.com/nrkno/tv-automation-server-core/commit/3829293))
...
### Bug Fixes
* **adlib**: An adlib replacing the main piece of a sl would not adjust the length of the original. F5/ ([fca6f05](https://github.com/nrkno/tv-automation-server-core/commit/fca6f05))
* **expected media items**: use a function instead of fat arrow ([fa23c05](https://github.com/nrkno/tv-automation-server-core/commit/fa23c05))
* **lookahead**: RETAIN mode now follows the WHEN_CLEAR behaviour instead of PRELOAD ([f0df41c](https://github.com/nrkno/tv-automation-server-core/commit/f0df41c))
* **migrations**: Broken StudioContext.updateDevice method ([7311d10](https://github.com/nrkno/tv-automation-server-core/commit/7311d10))
* **migrations**: DependOnResultFrom id was not being prefixed causing it to never work ([602740c](https://github.com/nrkno/tv-automation-server-core/commit/602740c))
...
* fix: reset disabled flag on SL and rundown reset ([8f69f67](https://github.com/nrkno/tv-automation-server-core/commit/8f69f67))
...
* **Handle received Rundown data when having added (adlibbed) segmentLines**
