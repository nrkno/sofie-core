...
import { IOutputLayerUi, PartUi, PieceUi, SegmentNoteCounts, SegmentUi } from '../SegmentContainer/withResolvedSegment.js'
						...
						<div className="segment-timeline__title__notes">
							{criticalNotes > 0 && (
								<div
									...
									onClick={() =>
										props.onHeaderNoteClick?.(props.segment._id, NoteSeverity.ERROR)
									}
							...
							{warningNotes > 0 && (
								<div
									...
									onClick={() =>
										props.onHeaderNoteClick?.(props.segment._id, NoteSeverity.WARNING)
									}
