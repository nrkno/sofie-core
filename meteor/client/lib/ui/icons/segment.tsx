...
export const CenterHandle = (props: React.SVGProps<SVGSVGElement>): JSX.Element => (
...
export const LeftArrow = (props: React.SVGProps<SVGSVGElement>): JSX.Element => (
	<svg width="6" height="13" viewBox="0 0 6 13" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
		<path d="M4.75 10.86L0.683707 6.5L4.75 2.14003L4.75 10.86Z" fill="black" stroke="white" />
	</svg>
)

export const SegmentEnd = (props: React.SVGProps<SVGSVGElement>): JSX.Element => (
...
export const SmallPartFlag = (props: React.SVGProps<SVGSVGElement>): JSX.Element => (
