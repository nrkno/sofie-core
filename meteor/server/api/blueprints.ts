...
import { parseVersion, ICoreSystem, CoreSystem, SYSTEM_ID, stripVersion } from '../../lib/collections/CoreSystem'
...
function uploadBlueprint (blueprintId: string, body: string, blueprintName: string) {
	...
	parseVersion(stripVersion(blueprintManifest.blueprintVersion))
	parseVersion(stripVersion(blueprintManifest.integrationVersion))
	parseVersion(stripVersion(blueprintManifest.TSRVersion))
	parseVersion(stripVersion(blueprintManifest.minimumCoreVersion))
