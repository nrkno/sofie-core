...
export class JoyConController extends ControllerAbstract {
	...
	private rangeRevMin = -1 // joystick "all back" position, the max-reverse-position
	private rangeNeutralMin = -0.25 // joystick "back" position where reverse-range transistions to the neutral range
	private rangeNeutralMax = 0.25 // joystick "front" position where scrolling starts, the 0 speed origin
	private rangeFwdMax = 1 // joystick "all front" position where scrolling is maxed out
