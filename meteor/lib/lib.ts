...
export function unReadOnlyProtectedString<T extends ProtectedString<any>>(val: ReadonlyDeep<T>): T {
	return val as any
}
export function unReadOnlyProtectedStringArray<T extends ProtectedString<any>>(val: ReadonlyDeep<T[]>): T[] {
	return val as any
}
