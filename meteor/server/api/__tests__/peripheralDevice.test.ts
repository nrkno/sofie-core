...
describe('peripheralDevice: MOS Basic functions', function () {
	...
	beforeEach(function () {
		...
		let segmentID = segmentId(roID, new MosString128('segment00'))
		Segments.insert({
			_id: segmentID,
			_rank: 0,
			mosId: 'segment00',
		...
		Segments.insert({
			_id: segmentId(roID, new MosString128('segment01')),
			_rank: 1,
			mosId: 'segment01',
			runningOrderId: roID,
			name: 'Water'
		...
		Segments.insert({
			_id: segmentId(roID, new MosString128('segment02')),
			_rank: 2,
			mosId: 'segment02',
			runningOrderId: roID,
			name: 'Earth'
		...
		Segments.insert({
			_id: segmentId(roID, new MosString128('segment10')),
			_rank: 0,
			mosId: 'segment10',
			runningOrderId: roID,
			name: 'Fire'
